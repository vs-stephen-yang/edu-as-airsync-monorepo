...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(value) =>
      "Udostępnianie ekranu wkrótce się zakończy. Czy chcesz przedłużyć je o 3 godziny? Możesz przedłużyć do ${value} razy.";

  static String m1(year, version) => "AirSync ©${year}. wersja ${version}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "eula_agree": MessageLookupByLibrary.simpleMessage("Zgadzam się"),
    "eula_disagree": MessageLookupByLibrary.simpleMessage("Nie zgadzam się"),
    ...
    "main_mirror_prompt_cancel": MessageLookupByLibrary.simpleMessage("Anuluj"),
    ...
    "main_settings_device_list": MessageLookupByLibrary.simpleMessage(
      "Szybkie hasło połączenia",
    ),
    "main_settings_device_name": MessageLookupByLibrary.simpleMessage("Nazwa"),
    ...
    "main_settings_share_to_sender": MessageLookupByLibrary.simpleMessage(
      "Udostępnij ekran urządzeniu",
    ),
    "main_settings_share_to_sender_limit_desc":
        MessageLookupByLibrary.simpleMessage(
          "Udostępnij ekran maksymalnie 10 nadawcom.",
        ),
    "main_settings_title": MessageLookupByLibrary.simpleMessage("Ustawienia"),
    ...
    "v3_broadcast_indicator": MessageLookupByLibrary.simpleMessage("WŁ."),
    "v3_broadcast_multicast_checkbox": MessageLookupByLibrary.simpleMessage(
      "Prześlij do 10-100 urządzeń",
    ),
    "v3_broadcast_multicast_desc": MessageLookupByLibrary.simpleMessage(
      "Liczba urządzeń odbierających nie może być zmieniona, gdy rozpocznie się projekcja.",
    ),
    "v3_broadcast_multicast_warn": MessageLookupByLibrary.simpleMessage(
      "Przerwij całą projekcję, aby edytować.",
    ),
    ...
    "v3_cast_to_device_list_msg": MessageLookupByLibrary.simpleMessage(
      "Maksymalnie do 10 urządzeń.",
    ),
    "v3_cast_to_device_menu_or": MessageLookupByLibrary.simpleMessage("Lub"),
    "v3_cast_to_device_menu_quick_connect1":
        MessageLookupByLibrary.simpleMessage("Szybkie połączenie"),
    "v3_cast_to_device_menu_quick_connect2":
        MessageLookupByLibrary.simpleMessage("przez skanowanie kodu QR"),
    "v3_cast_to_device_menu_title": MessageLookupByLibrary.simpleMessage(
      "Dołącz, aby odbierać ten ekran",
    ),
    ...
    "v3_cast_to_device_touch_back_disable":
        MessageLookupByLibrary.simpleMessage("Wyłącz"),
    ...
    "v3_casting_ended_toast": MessageLookupByLibrary.simpleMessage(
      "Udostępnianie ekranu zakończone.",
    ),
    "v3_casting_time_countdown": m0,
    "v3_casting_time_do_not_extend": MessageLookupByLibrary.simpleMessage(
      "Nie przedłużaj",
    ),
    "v3_casting_time_extend": MessageLookupByLibrary.simpleMessage("Przedłuż"),
    "v3_casting_time_extend_success_toast":
        MessageLookupByLibrary.simpleMessage("Przedłużono o 3 godziny."),
    "v3_download_app_desc": MessageLookupByLibrary.simpleMessage(
      "Zeskanuj kod QR urządzeniem z systemem iOS lub Android, aby pobrać",
    ),
    ...
    "v3_download_app_desktop_store": MessageLookupByLibrary.simpleMessage(
      "Zainstaluj MacOS przez App Store",
    ),
    ...
    "v3_download_app_for_desktop_desc": MessageLookupByLibrary.simpleMessage(
      "Wprowadź następujący adres URL, aby pobrać.",
    ),
    ...
    "v3_download_app_for_mobile_desc": MessageLookupByLibrary.simpleMessage(
      "Zeskanuj kod QR, aby uzyskać natychmiastowy dostęp.",
    ),
    "v3_download_app_mobile_title": MessageLookupByLibrary.simpleMessage(
      "Mobilny",
    ),
    "v3_download_app_or": MessageLookupByLibrary.simpleMessage("LUB"),
    ...
    "v3_exit_moderator_mode_desc": MessageLookupByLibrary.simpleMessage(
      "Czy na pewno? Spowoduje to rozłączenie wszystkich uczestników.",
    ),
    ...
    "v3_exit_moderator_mode_title": MessageLookupByLibrary.simpleMessage(
      "Wyjdź z trybu moderatora",
    ),
    "v3_group_dialog_accept": MessageLookupByLibrary.simpleMessage("Akceptuj"),
    "v3_group_dialog_decline": MessageLookupByLibrary.simpleMessage("Odrzuć"),
    "v3_group_dialog_message": MessageLookupByLibrary.simpleMessage(
      "%s wysłał żądanie transmisji na Twoje urządzenie. Ta akcja zsynchronizuje i wyświetli bieżącą zawartość, czy chcesz zaakceptować to żądanie?",
    ),
    ...
    "v3_group_reject_invited": MessageLookupByLibrary.simpleMessage(
      "odrzucił Twoje żądanie transmisji, proszę sprawdzić ustawienia transmisji.",
    ),
    ...
    "v3_help_center_cast_device_title_sub":
        MessageLookupByLibrary.simpleMessage(
          "IFP przesyłający swój ekran do urządzeń.",
        ),
    "v3_help_center_close": MessageLookupByLibrary.simpleMessage("Zamknij"),
    ...
    "v3_help_center_touchback_title_sub": MessageLookupByLibrary.simpleMessage(
      "Umożliwienie użytkownikowi zdalnego sterowania.",
    ),
    "v3_help_center_untouchback_title": MessageLookupByLibrary.simpleMessage(
      "Wyłącz sterowanie dotykowe",
    ),
    "v3_help_center_untouchback_title_sub":
        MessageLookupByLibrary.simpleMessage(
          "Odłącz tryb sterowania dotykowego.",
        ),
    "v3_instruction1a": MessageLookupByLibrary.simpleMessage("Instrukcja 1a"),
    "v3_instruction1b": MessageLookupByLibrary.simpleMessage(
      "Otwórz aplikację AisSync",
    ),
    "v3_instruction2": MessageLookupByLibrary.simpleMessage(
      "Wprowadź kod wyświetlacza",
    ),
    ...
    "v3_last_casting_time_countdown": MessageLookupByLibrary.simpleMessage(
      "Udostępnianie ekranu wkrótce się zakończy. Proszę ponownie uruchomić udostępnianie ekranu, jeśli to konieczne.",
    ),
    ...
    "v3_lbl_cast_device_close": MessageLookupByLibrary.simpleMessage(
      "Zamknij połączenie z urządzeniem przesyłanym",
    ),
    ...
    "v3_lbl_minimal_quick_connect_menu": MessageLookupByLibrary.simpleMessage(
      "Zminimalizuj menu szybkiego połączenia",
    ),
    "v3_lbl_minimal_streaming_qrcode_menu":
        MessageLookupByLibrary.simpleMessage(
          "Zminimalizuj menu kodów QR strumieniowania",
        ),
    ...
    "v3_lbl_resizable_minimize": MessageLookupByLibrary.simpleMessage(
      "Zminimalizuj kontrolę prezentacji",
    ),
    ...
    "v3_lbl_settings_broadcast": MessageLookupByLibrary.simpleMessage(
      "Otwórz menu ustawień transmisji",
    ),
    ...
    "v3_lbl_settings_broadcast_to_display_group":
        MessageLookupByLibrary.simpleMessage(
          "Otwórz menu transmisji do grupy wyświetlania",
        ),
    "v3_lbl_settings_broadcast_to_display_group_cast":
        MessageLookupByLibrary.simpleMessage("Nadawaj"),
    "v3_lbl_settings_broadcast_to_display_group_checkbox":
        MessageLookupByLibrary.simpleMessage("Wybierz %s"),
    "v3_lbl_settings_broadcast_to_display_group_confirm":
        MessageLookupByLibrary.simpleMessage(
          "Potwierdź, że nie wybrano urządzenia.",
        ),
    ...
    "v3_lbl_settings_connectivity": MessageLookupByLibrary.simpleMessage(
      "Otwórz menu ustawień łączności",
    ),
    "v3_lbl_settings_connectivity_item": MessageLookupByLibrary.simpleMessage(
      "Wybierz %s",
    ),
    "v3_lbl_settings_device_authorize_mode":
        MessageLookupByLibrary.simpleMessage("Włącz/wyłącz tryb autoryzacji"),
    "v3_lbl_settings_device_auto_fill_otp":
        MessageLookupByLibrary.simpleMessage(
          "Włącz/wyłącz tryb automatycznego wypełniania OTP",
        ),
    "v3_lbl_settings_device_high_image_quality":
        MessageLookupByLibrary.simpleMessage("Wysoka jakość obrazu"),
    "v3_lbl_settings_device_launch_on_startup":
        MessageLookupByLibrary.simpleMessage(
          "Włącz/wyłącz tryb automatycznego uruchamiania",
        ),
    ...
    "v3_lbl_settings_device_name_close": MessageLookupByLibrary.simpleMessage(
      "Zamknij ustawienie nazwy urządzenia",
    ),
    ...
    "v3_lbl_settings_device_setting": MessageLookupByLibrary.simpleMessage(
      "Otwórz menu ustawień urządzenia",
    ),
    "v3_lbl_settings_device_smart_scaling":
        MessageLookupByLibrary.simpleMessage(
          "Włącz/wyłącz przełącznik inteligentnego skalowania",
        ),
    ...
    "v3_lbl_settings_invite_group": MessageLookupByLibrary.simpleMessage(
      "Otwórz menu rozwijane transmisji ekranu",
    ),
    ...
    "v3_lbl_settings_legal_policy": MessageLookupByLibrary.simpleMessage(
      "Otwórz menu prawne i polityki w ustawieniach",
    ),
    "v3_lbl_settings_menu_locked": MessageLookupByLibrary.simpleMessage(
      "Menu Ustawienia jest zablokowane",
    ),
    "v3_lbl_settings_mirroring_auto_accept":
        MessageLookupByLibrary.simpleMessage(
          "Włącz/wyłącz automatyczne akceptowanie",
        ),
    ...
    "v3_lbl_settings_show_display_code": MessageLookupByLibrary.simpleMessage(
      "Włącz/wyłącz przełącznik kodu wyświetlania",
    ),
    "v3_lbl_settings_whats_new": MessageLookupByLibrary.simpleMessage(
      "Otwórz menu co nowego w ustawieniach",
    ),
    ...
    "v3_lbl_streaming_view_function_expand":
        MessageLookupByLibrary.simpleMessage("Rozwiń funkcję strumieniowania"),
    "v3_lbl_streaming_view_function_minimize":
        MessageLookupByLibrary.simpleMessage("Zwiń funkcję strumieniowania"),
    "v3_lbl_streaming_view_minimize": MessageLookupByLibrary.simpleMessage(
      "Zwiń widok strumieniowania",
    ),
    ...
    "v3_main_local_connection_only_dialog_desc":
        MessageLookupByLibrary.simpleMessage(
          "Tylko połączenie LAN, proszę sprawdzić ustawienia sieci urządzenia.",
        ),
    "v3_main_status_no_network": MessageLookupByLibrary.simpleMessage(
      "Nie można wykryć połączenia internetowego. Proszę połączyć się z siecią Wi-Fi lub intranetową i spróbować ponownie.",
    ),
    "v3_miracast_not_support": MessageLookupByLibrary.simpleMessage(
      "Miracast jest teraz niedostępny. Bieżący kanał Wi-Fi nie obsługuje przesyłania ekranu.",
    ),
    "v3_miracast_uibc_not_supported_message":
        MessageLookupByLibrary.simpleMessage(
          "To źródło nie obsługuje sterowania dotykowego Miracast",
        ),
    "v3_mirror_request_passcode": MessageLookupByLibrary.simpleMessage("Hasło"),
    ...
    "v3_moderator_disable_mirror_desc": MessageLookupByLibrary.simpleMessage(
      "Dublowanie zostanie wyłączone w trybie moderatora",
    ),
    ...
    "v3_moderator_disable_mirror_title": MessageLookupByLibrary.simpleMessage(
      "Wyłącz dublowanie dla trybu moderatora",
    ),
    ...
    "v3_participant_item_controlling": MessageLookupByLibrary.simpleMessage(
      "Odbieranie + Sterowanie dotykowe",
    ),
    ...
    "v3_quick_connect_menu_bottom_msg": MessageLookupByLibrary.simpleMessage(
      "Podzielony ekran aktywuje się, gdy dwóch lub więcej użytkowników udostępnia ekrany.",
    ),
    ...
    "v3_setting_passcode_title": MessageLookupByLibrary.simpleMessage(
      "Wprowadź hasło, aby odblokować Ustawienia",
    ),
    ...
    "v3_settings_all_the_time_info": MessageLookupByLibrary.simpleMessage(
      "Nadawaj ekran źródłowego IFP cały czas.",
    ),
    "v3_settings_broadcast": MessageLookupByLibrary.simpleMessage("Transmisja"),
    "v3_settings_broadcast_boards": MessageLookupByLibrary.simpleMessage(
      "Inne urządzenia AirSync",
    ),
    ...
    "v3_settings_broadcast_cast_boards_desc": MessageLookupByLibrary.simpleMessage(
      "Udostępnij ten ekran wszystkim interaktywnym panelom płaskim (IFP) w sieci.",
    ),
    ...
    "v3_settings_broadcast_screen_energy_saving":
        MessageLookupByLibrary.simpleMessage(
          "Proszę wyłączyć oszczędzanie energii, aby uniknąć nieoczekiwanych przerw podczas transmisji.",
        ),
    "v3_settings_broadcast_to_display_group":
        MessageLookupByLibrary.simpleMessage("Nadawaj do grupy wyświetlania"),
    ...
    "v3_settings_connectivity_both": MessageLookupByLibrary.simpleMessage(
      "Zarówno połączenie internetowe, jak i lokalne",
    ),
    ...
    "v3_settings_connectivity_internet_desc":
        MessageLookupByLibrary.simpleMessage(
          "Połączenie internetowe wymaga stabilnej sieci.",
        ),
    ...
    "v3_settings_connectivity_local_desc": MessageLookupByLibrary.simpleMessage(
      "Połączenia lokalne działają w prywatnej sieci, oferując większe bezpieczeństwo i stabilność.",
    ),
    "v3_settings_device_authorize_mode": MessageLookupByLibrary.simpleMessage(
      "Wymagaj zatwierdzenia dla wszystkich żądań udostępniania ekranu.",
    ),
    "v3_settings_device_auto_fill_otp": MessageLookupByLibrary.simpleMessage(
      "Automatycznie wypełniaj jednorazowe hasło",
    ),
    "v3_settings_device_auto_fill_otp_desc": MessageLookupByLibrary.simpleMessage(
      "Włącz połączenie jednym dotknięciem, gdy to urządzenie zostanie wybrane z menu szybkiego połączenia w aplikacji nadawcy.",
    ),
    "v3_settings_device_high_image_quality":
        MessageLookupByLibrary.simpleMessage("Wysoka jakość obrazu"),
    "v3_settings_device_high_image_quality_off_desc":
        MessageLookupByLibrary.simpleMessage(
          "Maksymalne udostępnianie ekranu QHD (2K), w zależności od rozdzielczości ekranu nadawcy.",
        ),
    "v3_settings_device_high_image_quality_on_desc":
        MessageLookupByLibrary.simpleMessage(
          "Maksymalne udostępnianie ekranu UHD (4K) z nadajnika internetowego i 3K+ z nadajników Windows i macOS, w zależności od rozdzielczości ekranu nadawcy. Wymaga wysokiej jakości sieci.",
        ),
    "v3_settings_device_launch_on_startup":
        MessageLookupByLibrary.simpleMessage("Uruchom AirSync przy starcie"),
    ...
    "v3_settings_device_not_supported": MessageLookupByLibrary.simpleMessage(
      "Wersja urządzenia nie jest obsługiwana",
    ),
    "v3_settings_device_setting": MessageLookupByLibrary.simpleMessage(
      "Ustawienia urządzenia",
    ),
    "v3_settings_device_show_display_code":
        MessageLookupByLibrary.simpleMessage("Pokaż kod wyświetlania na górze"),
    "v3_settings_device_show_display_code_desc":
        MessageLookupByLibrary.simpleMessage(
          "Utrzymaj kod widoczny na górze ekranu, nawet podczas przełączania na inne aplikacje i aktywnego udostępniania ekranu.",
        ),
    ...
    "v3_settings_device_smart_scaling_desc": MessageLookupByLibrary.simpleMessage(
      "Automatycznie dostosuj rozmiar ekranu, aby zmaksymalizować wykorzystanie przestrzeni ekranu. Obraz może być nieco zniekształcony.",
    ),
    ...
    "v3_settings_mirroring_auto_accept_desc": MessageLookupByLibrary.simpleMessage(
      "Natychmiast włącz dublowanie bez wymagania zatwierdzenia przez moderatora.",
    ),
    "v3_settings_mirroring_blocked": MessageLookupByLibrary.simpleMessage(
      "Najpierw wyłącz tryb moderatora.",
    ),
    ...
    "v3_settings_open_source_license": MessageLookupByLibrary.simpleMessage(
      "Licencje na otwarte oprogramowanie",
    ),
    ...
    "v3_settings_privacy_policy_description": MessageLookupByLibrary.simpleMessage(
      "ViewSonic zobowiązuje się do ochrony Twojej prywatności i poważnie traktuje obchodzenie się z danymi osobowymi. Poniższa Polityka prywatności szczegółowo opisuje, jak ViewSonic będzie postępować z Twoimi danymi osobowymi po ich zebraniu przez ViewSonic poprzez Twoje korzystanie ze Strony internetowej. ViewSonic utrzymuje prywatność Twoich informacji, używając technologii bezpieczeństwa i przestrzega zasad, które zapobiegają nieautoryzowanemu użyciu Twoich danych osobowych. Korzystając z tej Strony internetowej, wyrażasz zgodę na zbieranie i używanie Twoich informacji.\n\nStrony internetowe, do których linkujesz z ViewSonic.com, mogą mieć własną politykę prywatności, która może różnić się od ViewSonic. Przejrzyj polityki prywatności tych stron, aby uzyskać szczegółowe informacje o tym, jak mogą używać informacji zebranych podczas Twojej wizyty na nich.\n\nKliknij poniższe linki, aby dowiedzieć się więcej o naszej Polityce prywatności.",
    ),
    ...
    "v3_settings_whats_new": MessageLookupByLibrary.simpleMessage("Co nowego"),
    "v3_settings_whats_new_content": MessageLookupByLibrary.simpleMessage(
      "AirSync %s\n\nAirSync to zastrzeżone rozwiązanie ViewSonic do bezprzewodowego udostępniania ekranu. Używane z nadajnikiem AirSync, umożliwia użytkownikom płynne udostępnianie ekranów interaktywnym wyświetlaczom ViewSonic.\n\nTa wersja zawiera następujące nowe funkcje:\n\n1. Obsługa widoku podzielonego ekranu ViewBoard.\n\n2. Obsługa udostępniania ekranu w wysokiej jakości (do 4K) za pośrednictwem nadajnika internetowego.\n\n3. Wyciszanie wyjścia audio urządzenia podczas udostępniania za pośrednictwem nadajnika Windows.\n\n4. Zwiększona stabilność.\n\n5. Naprawiono różne błędy.\n",
    ),
    "v3_shortcuts_airplay": MessageLookupByLibrary.simpleMessage(
      "Skróty airplay",
    ),
    "v3_shortcuts_cast_device": MessageLookupByLibrary.simpleMessage(
      "Przesyłaj na urządzenia",
    ),
    ...
    "v3_shortcuts_miracast": MessageLookupByLibrary.simpleMessage(
      "Skróty Miracast",
    ),
    ...
    "v3_touchback_alert_message": MessageLookupByLibrary.simpleMessage(
      "Możesz sterować dotykiem tylko jednym urządzeniem naraz.",
    ),
    "v3_touchback_alert_title": MessageLookupByLibrary.simpleMessage(
      "Sterowanie dotykowe do %s?",
    ),
    ...
    "v3_touchback_restart_bluetooth_title": MessageLookupByLibrary.simpleMessage(
      "Przekroczono limit czasu operacji, proszę ponownie uruchomić Bluetooth",
    ),
    "v3_touchback_state_deviceFinding_message":
        MessageLookupByLibrary.simpleMessage("Wyszukiwanie urządzenia"),
    "v3_touchback_state_deviceFoundSuccess_message":
        MessageLookupByLibrary.simpleMessage("Urządzenie znalezione pomyślnie"),
    "v3_touchback_state_devicePairedSuccess_message":
        MessageLookupByLibrary.simpleMessage("Urządzenie sparowane pomyślnie"),
    "v3_touchback_state_devicePairing_message":
        MessageLookupByLibrary.simpleMessage("Parowanie urządzenia"),
    "v3_touchback_state_hidConnected_message":
        MessageLookupByLibrary.simpleMessage("HID połączone"),
    "v3_touchback_state_hidConnecting_message":
        MessageLookupByLibrary.simpleMessage("Łączenie HID"),
    "v3_touchback_state_hidProfileServiceStartedSuccess_message":
        MessageLookupByLibrary.simpleMessage(
          "Usługa profilu HID uruchomiona pomyślnie",
        ),
    "v3_touchback_state_hidProfileServiceStarting_message":
        MessageLookupByLibrary.simpleMessage("Uruchamianie usługi profilu HID"),
    "v3_touchback_state_initialized_message":
        MessageLookupByLibrary.simpleMessage("Zainicjowane"),
    "v3_touchback_state_initializing_message":
        MessageLookupByLibrary.simpleMessage("Inicjowanie"),
    "v3_touchback_success_message": MessageLookupByLibrary.simpleMessage(
      "Możesz teraz zdalnie sterować %s z IFP.",
    ),
