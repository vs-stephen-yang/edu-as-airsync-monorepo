...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "main_feature_no_network_warning":
            MessageLookupByLibrary.simpleMessage("控制連線異常，請重新連線"),
        ...
        "v3_authorize_prompt_accept":
            MessageLookupByLibrary.simpleMessage("接受"),
        "v3_authorize_prompt_accept_all":
            MessageLookupByLibrary.simpleMessage("一律接受"),
        ...
        "v3_casting_ended_toast":
            MessageLookupByLibrary.simpleMessage("螢幕分享已結束。"),
        "v3_casting_time_countdown": m0,
        "v3_casting_time_do_not_extend":
            MessageLookupByLibrary.simpleMessage("不延長"),
        ...
        "v3_download_app_desktop":
            MessageLookupByLibrary.simpleMessage("取得最佳化體驗版本!"),
        "v3_download_app_desktop_hint":
            MessageLookupByLibrary.simpleMessage("自行安裝檔"),
        "v3_download_app_desktop_store":
            MessageLookupByLibrary.simpleMessage("下載商店版本"),
        "v3_download_app_desktop_store_hint":
            MessageLookupByLibrary.simpleMessage("MacOS專用版"),
        "v3_download_app_desktop_title":
            MessageLookupByLibrary.simpleMessage("一般裝置"),
        ...
        "v3_exit_moderator_mode_cancel":
            MessageLookupByLibrary.simpleMessage("取消"),
        "v3_exit_moderator_mode_desc":
            MessageLookupByLibrary.simpleMessage("確定結束主持人模式並中斷所有連線嗎? "),
        "v3_exit_moderator_mode_exit":
            MessageLookupByLibrary.simpleMessage("退出"),
        ...
        "v3_group_receive_view_status_from":
            MessageLookupByLibrary.simpleMessage("廣播來自於"),
        "v3_group_receive_view_status_stop":
            MessageLookupByLibrary.simpleMessage("停止"),
        "v3_group_reject_invited":
            MessageLookupByLibrary.simpleMessage("拒絕您的廣播請求，請檢查接收端設置"),
        "v3_help_center_cast_device_title":
            MessageLookupByLibrary.simpleMessage("分享大屏端畫面至裝置"),
        "v3_help_center_cast_device_title_sub":
            MessageLookupByLibrary.simpleMessage("將大屏端畫面分享至裝置端"),
        "v3_help_center_close": MessageLookupByLibrary.simpleMessage("關閉"),
        "v3_help_center_fullscreen_title":
            MessageLookupByLibrary.simpleMessage("全螢幕"),
        "v3_help_center_mute_user_title":
            MessageLookupByLibrary.simpleMessage("靜音"),
        "v3_help_center_remove_user_title":
            MessageLookupByLibrary.simpleMessage("移除使用者"),
        "v3_help_center_share_title":
            MessageLookupByLibrary.simpleMessage("分享螢幕"),
        "v3_help_center_share_title_sub":
            MessageLookupByLibrary.simpleMessage("將裝置端畫面分享至大屏"),
        "v3_help_center_stop_share_title":
            MessageLookupByLibrary.simpleMessage("停止分享"),
        "v3_help_center_title": MessageLookupByLibrary.simpleMessage("支援中心"),
        "v3_help_center_touchback_title":
            MessageLookupByLibrary.simpleMessage("反控"),
        "v3_help_center_touchback_title_sub":
            MessageLookupByLibrary.simpleMessage("允許使用者遠端控制"),
        "v3_help_center_untouchback_title":
            MessageLookupByLibrary.simpleMessage("停止反控"),
        "v3_help_center_untouchback_title_sub":
            MessageLookupByLibrary.simpleMessage("停止使用者遠端控制"),
        "v3_instruction1a":
        ...
        "v3_last_casting_time_countdown":
            MessageLookupByLibrary.simpleMessage("螢幕分享即將結束。如需要，請重新開始分享螢幕。"),
        "v3_lbl_authorize_prompt_accept":
            MessageLookupByLibrary.simpleMessage("接受請求"),
        "v3_lbl_authorize_prompt_accept_all":
            MessageLookupByLibrary.simpleMessage("一律接受所有請求"),
        "v3_lbl_authorize_prompt_decline":
            MessageLookupByLibrary.simpleMessage("拒絕請求"),
        "v3_lbl_cast_device_close":
            MessageLookupByLibrary.simpleMessage("結束與設備端連線"),
        "v3_lbl_cast_device_touchback_disable":
            MessageLookupByLibrary.simpleMessage("關閉反控"),
        "v3_lbl_cast_device_touchback_enable":
            MessageLookupByLibrary.simpleMessage("啟動反控"),
        "v3_lbl_close_download_app_menu":
            MessageLookupByLibrary.simpleMessage("關閉下載sender app選單"),
        "v3_lbl_close_feature_set_cast_device":
            MessageLookupByLibrary.simpleMessage("關閉設備清單"),
        "v3_lbl_close_feature_set_moderator":
            MessageLookupByLibrary.simpleMessage("關閉主持人模式參與人員清單"),
        "v3_lbl_close_help_center":
            MessageLookupByLibrary.simpleMessage("關閉支援中心"),
        "v3_lbl_close_streaming_shortcut_menu":
            MessageLookupByLibrary.simpleMessage("收合投影控制捷徑"),
        "v3_lbl_connection_dialog_close":
            MessageLookupByLibrary.simpleMessage("關閉連線狀態對話框"),
        "v3_lbl_eula_agree":
            MessageLookupByLibrary.simpleMessage("同意終端使用者授權合約"),
        "v3_lbl_eula_disagree":
            MessageLookupByLibrary.simpleMessage("不同意終端使用者授權合約"),
        "v3_lbl_exit_moderator_cancel":
            MessageLookupByLibrary.simpleMessage("取消結束主持人模式"),
        "v3_lbl_exit_moderator_exit":
            MessageLookupByLibrary.simpleMessage("確定結束主持人模式"),
        "v3_lbl_extend_casting_do_not_extend":
            MessageLookupByLibrary.simpleMessage("不延長投影時間"),
        "v3_lbl_extend_casting_extend":
            MessageLookupByLibrary.simpleMessage("延長投影時間"),
        "v3_lbl_group_reject_close":
            MessageLookupByLibrary.simpleMessage("關閉提示"),
        ...
        "v3_lbl_minimal_quick_connect_menu":
            MessageLookupByLibrary.simpleMessage("縮小快速連線選單"),
        "v3_lbl_minimal_streaming_qrcode_menu":
            MessageLookupByLibrary.simpleMessage("隱藏QR code視窗"),
        "v3_lbl_moderator_toggle":
            MessageLookupByLibrary.simpleMessage("主持人模式開關"),
        "v3_lbl_open_download_app_menu":
            MessageLookupByLibrary.simpleMessage("開啟下載sender app選單"),
        "v3_lbl_open_feature_set_cast_device":
            MessageLookupByLibrary.simpleMessage("開啟設備清單"),
        "v3_lbl_open_feature_set_moderator":
            MessageLookupByLibrary.simpleMessage("開啟主持人模式參與人員清單"),
        "v3_lbl_open_help_center":
            MessageLookupByLibrary.simpleMessage("開啟支援中心"),
        "v3_lbl_open_menu_settings":
            MessageLookupByLibrary.simpleMessage("開啟設定功能選單"),
        "v3_lbl_open_streaming_qrcode_menu":
            MessageLookupByLibrary.simpleMessage("顯示QR code視窗"),
        "v3_lbl_open_streaming_shortcut_menu":
            MessageLookupByLibrary.simpleMessage("展開投影控制捷徑"),
        "v3_lbl_overlay_bring_app_to_top":
            MessageLookupByLibrary.simpleMessage("常駐連線資訊狀態列"),
        "v3_lbl_overlay_menu_expand":
            MessageLookupByLibrary.simpleMessage("展開常駐選單"),
        "v3_lbl_overlay_menu_minimize":
            MessageLookupByLibrary.simpleMessage("最小化常駐選單"),
        "v3_lbl_participant_cast_device":
            MessageLookupByLibrary.simpleMessage("分享畫面給參與者"),
        "v3_lbl_participant_close":
            MessageLookupByLibrary.simpleMessage("結束參與者的連線"),
        "v3_lbl_participant_disconnect":
            MessageLookupByLibrary.simpleMessage("結束參與者的連線"),
        "v3_lbl_participant_mirror_close":
            MessageLookupByLibrary.simpleMessage("中斷連線"),
        "v3_lbl_participant_mirror_share":
            MessageLookupByLibrary.simpleMessage("分享畫面"),
        "v3_lbl_participant_mirror_stop":
            MessageLookupByLibrary.simpleMessage("停止鏡射"),
        "v3_lbl_participant_share":
            MessageLookupByLibrary.simpleMessage("分享畫面到參與人員"),
        "v3_lbl_participant_stop":
            MessageLookupByLibrary.simpleMessage("停止參與者的投影"),
        "v3_lbl_participant_touch_back":
            MessageLookupByLibrary.simpleMessage("啟動參與者反控"),
        "v3_lbl_participant_touch_back_disable":
            MessageLookupByLibrary.simpleMessage("取消"),
        "v3_lbl_resizable_expand":
            MessageLookupByLibrary.simpleMessage("展開投影控制列"),
        "v3_lbl_resizable_minimize":
            MessageLookupByLibrary.simpleMessage("縮小投影控制列"),
        ...
        "v3_lbl_settings_accessibility":
            MessageLookupByLibrary.simpleMessage("可訪問性"),
        "v3_lbl_settings_back_icon":
            MessageLookupByLibrary.simpleMessage("回到上一頁"),
        "v3_lbl_settings_broadcast":
            MessageLookupByLibrary.simpleMessage("展開螢幕廣播設定選單"),
        "v3_lbl_settings_broadcast_boards":
            MessageLookupByLibrary.simpleMessage("展開廣播到大屏選單"),
        "v3_lbl_settings_broadcast_devices":
            MessageLookupByLibrary.simpleMessage("展開螢幕廣播選單"),
        ...
        "v3_lbl_settings_close_icon":
            MessageLookupByLibrary.simpleMessage("關閉設定選單"),
        "v3_lbl_settings_connectivity":
            MessageLookupByLibrary.simpleMessage("展開連線模式設定選單"),
        ...
        "v3_lbl_settings_device_name":
            MessageLookupByLibrary.simpleMessage("更改裝置名稱"),
        "v3_lbl_settings_device_name_close":
            MessageLookupByLibrary.simpleMessage("關閉裝置名稱設定"),
        "v3_lbl_settings_device_name_save":
            MessageLookupByLibrary.simpleMessage("儲存裝置名稱"),
        "v3_lbl_settings_device_setting":
            MessageLookupByLibrary.simpleMessage("展開裝置設定選單"),
        "v3_lbl_settings_device_smart_scaling":
            MessageLookupByLibrary.simpleMessage("開啟或關閉智慧滿屏"),
        "v3_lbl_settings_enter_device_name":
            MessageLookupByLibrary.simpleMessage("輸入裝置名稱"),
        "v3_lbl_settings_invite_group":
            MessageLookupByLibrary.simpleMessage("展開螢幕廣播邀請選單"),
        "v3_lbl_settings_invite_group_item":
            MessageLookupByLibrary.simpleMessage("選擇 %s"),
        "v3_lbl_settings_legal_policy":
            MessageLookupByLibrary.simpleMessage("展開法律和政策"),
        "v3_lbl_settings_menu_locked":
            MessageLookupByLibrary.simpleMessage("設定功能已鎖定"),
        ...
        "v3_lbl_settings_show_display_code":
            MessageLookupByLibrary.simpleMessage("開啟或關閉投影辨識碼"),
        "v3_lbl_settings_whats_new":
            MessageLookupByLibrary.simpleMessage("展開what\'s new"),
        "v3_lbl_settings_whats_new_icon":
            MessageLookupByLibrary.simpleMessage("最新消息圖示"),
        "v3_lbl_shortcuts_airplay":
            MessageLookupByLibrary.simpleMessage("開啟或關閉AirPlay"),
        "v3_lbl_shortcuts_google_cast":
            MessageLookupByLibrary.simpleMessage("開啟或關閉Google Cast"),
        "v3_lbl_shortcuts_miracast":
            MessageLookupByLibrary.simpleMessage("開啟或關閉Miracast"),
        "v3_lbl_shortcuts_mirroring":
            MessageLookupByLibrary.simpleMessage("展開螢幕鏡射設定選單"),
        "v3_lbl_streaming_airplay_touchback":
            MessageLookupByLibrary.simpleMessage("AirPlay反控"),
        ...
        "v3_lbl_streaming_shortcut_expand":
            MessageLookupByLibrary.simpleMessage("展開功能捷徑列"),
        ...
        "v3_lbl_streaming_view_minimize":
            MessageLookupByLibrary.simpleMessage("收合分享畫面"),
        "v3_lbl_streaming_view_mute":
            MessageLookupByLibrary.simpleMessage("靜音"),
        "v3_lbl_streaming_view_stop":
            MessageLookupByLibrary.simpleMessage("結束分享畫面"),
        "v3_lbl_streaming_view_unmute":
            MessageLookupByLibrary.simpleMessage("取消靜音"),
        ...
        "v3_miracast_not_support":
            MessageLookupByLibrary.simpleMessage("目前使用的Wi-Fi頻道不支援Miracast功能"),
        ...
        "v3_participant_item_casting":
            MessageLookupByLibrary.simpleMessage("投影中"),
        ...
        "v3_setting_passcode_title":
            MessageLookupByLibrary.simpleMessage("請輸入解鎖密碼"),
        "v3_settings_accessibility":
            MessageLookupByLibrary.simpleMessage("無障礙協助"),
        ...
        "v3_settings_connectivity":
            MessageLookupByLibrary.simpleMessage("連線方式"),
        "v3_settings_connectivity_both":
            MessageLookupByLibrary.simpleMessage("接受網際網路與區域網路連線"),
        "v3_settings_connectivity_internet":
            MessageLookupByLibrary.simpleMessage("僅接受網際網路連線"),
        "v3_settings_connectivity_internet_desc":
            MessageLookupByLibrary.simpleMessage("需要穩定的網路品質"),
        "v3_settings_connectivity_local":
            MessageLookupByLibrary.simpleMessage("僅接受區域網路連線"),
        "v3_settings_connectivity_local_desc":
            MessageLookupByLibrary.simpleMessage("透過區域網路連線，可提供更多的安全性和穩定性"),
        "v3_settings_device_authorize_mode":
            MessageLookupByLibrary.simpleMessage("允許後才能分享螢幕"),
        "v3_settings_device_auto_fill_otp":
            MessageLookupByLibrary.simpleMessage("自動填入一次性密碼"),
        ...
        "v3_settings_device_name_empty_error":
            MessageLookupByLibrary.simpleMessage("設備名稱不可為空白"),
        "v3_settings_device_name_save":
            MessageLookupByLibrary.simpleMessage("儲存"),
        "v3_settings_device_setting":
            MessageLookupByLibrary.simpleMessage("裝置設定"),
        ...
        "v3_settings_display_group":
            MessageLookupByLibrary.simpleMessage("螢幕群組"),
        ...
        "v3_settings_invite_group_ignore":
            MessageLookupByLibrary.simpleMessage("永遠拒絕"),
        ...
        "v3_settings_resize_text_size":
            MessageLookupByLibrary.simpleMessage("調整字體大小"),
        ...
        "v3_shortcuts_menu_title":
            MessageLookupByLibrary.simpleMessage("快速功能區"),
        "v3_shortcuts_miracast":
            MessageLookupByLibrary.simpleMessage("Miracast"),
        "v3_shortcuts_mirroring": MessageLookupByLibrary.simpleMessage("螢幕鏡射"),
        "v3_touchback_alert_message":
            MessageLookupByLibrary.simpleMessage("一次只能反控一台設備"),
        "v3_touchback_alert_title":
            MessageLookupByLibrary.simpleMessage("啟用反控%s?"),
        "v3_touchback_disable_message":
            MessageLookupByLibrary.simpleMessage("反控已關閉"),
        "v3_touchback_fail_message":
            MessageLookupByLibrary.simpleMessage("配對失敗，未啟用反控。請重新操作。"),
        ...
        "v3_touchback_success_message":
            MessageLookupByLibrary.simpleMessage("您可以開始從大屏反控設備端"),
