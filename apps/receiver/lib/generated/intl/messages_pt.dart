...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(value) =>
      "O compartilhamento de tela está prestes a terminar. Gostaria de estendê-lo por 3 horas? Você pode estender até ${value} vezes.";

  static String m1(year, version) => "AirSync ©${year}. versão ${version}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "eula_agree": MessageLookupByLibrary.simpleMessage("Eu Concordo"),
    "eula_disagree": MessageLookupByLibrary.simpleMessage("Eu Discordo"),
    "eula_title": MessageLookupByLibrary.simpleMessage("EULA do AirSync"),
    "main_airplay_pin_code": MessageLookupByLibrary.simpleMessage(
      "Código AirPlay",
    ),
    "main_auto_startup": MessageLookupByLibrary.simpleMessage(
      "Iniciar o AirSync na inicialização",
    ),
    ...
    "main_feature_no_network_warning": MessageLookupByLibrary.simpleMessage(
      "A conexão de controle está desconectada. Por favor, reconecte",
    ),
    "main_feature_reconnect_fail_toast": MessageLookupByLibrary.simpleMessage(
      "Falha ao reconectar rede (Controle)",
    ),
    "main_feature_reconnect_success_toast":
        MessageLookupByLibrary.simpleMessage(
          "Reconexão de rede (Controle) bem-sucedida",
        ),
    "main_feature_reconnecting_toast": MessageLookupByLibrary.simpleMessage(
      "Reconectando rede (Controle)",
    ),
    "main_get_display_code_failure": MessageLookupByLibrary.simpleMessage(
      "Falha ao obter o código de exibição. Aguarde a conectividade de rede ser retomada ou reinicie o aplicativo.",
    ),
    "main_language_name": MessageLookupByLibrary.simpleMessage("Português"),
    "main_language_title": MessageLookupByLibrary.simpleMessage("Idioma"),
    "main_limit_time_message": MessageLookupByLibrary.simpleMessage(
      "Faltam 5 minutos",
    ),
    "main_mirror_from_client": MessageLookupByLibrary.simpleMessage(
      "%s gostaria de compartilhar sua tela.",
    ),
    ...
    "main_register_display_code_failure": MessageLookupByLibrary.simpleMessage(
      "Falha ao obter Código de Exibição e Senha Única. Isso pode ser devido a um problema de rede ou servidor. Tente novamente mais tarde quando a conexão for restaurada.",
    ),
    ...
    "main_settings_device_list": MessageLookupByLibrary.simpleMessage(
      "Senha de Conexão Rápida",
    ),
    "main_settings_device_name": MessageLookupByLibrary.simpleMessage("Nome"),
    ...
    "main_settings_language": MessageLookupByLibrary.simpleMessage("Idioma"),
    "main_settings_mirror_confirmation": MessageLookupByLibrary.simpleMessage(
      "Confirmação de espelhamento",
    ),
    ...
    "main_settings_share_to_sender": MessageLookupByLibrary.simpleMessage(
      "Compartilhar tela com o dispositivo",
    ),
    "main_settings_share_to_sender_limit_desc":
        MessageLookupByLibrary.simpleMessage(
          "Compartilhar tela com até 10 dispositivos.",
        ),
    ...
    "main_split_screen_question": MessageLookupByLibrary.simpleMessage(
      "Clique no botão acima para o Modo de Tela Dividida. Até 4 participantes podem apresentar ao mesmo tempo.",
    ),
    ...
    "toast_maximum_split_screen": MessageLookupByLibrary.simpleMessage(
      "Quantidade máxima de telas divididas atingida.",
    ),
    ...
    "update_title": MessageLookupByLibrary.simpleMessage("Atualização AirSync"),
    ...
    "v3_authorize_prompt_notification_cast": MessageLookupByLibrary.simpleMessage(
      "Desmarque “Exigir aprovação” no menu Configurações para aceitar todas as solicitações de transmissão.",
    ),
    "v3_authorize_prompt_notification_mirror": MessageLookupByLibrary.simpleMessage(
      "Marque “Aceitar automaticamente” no menu Configurações para aceitar todas as solicitações de espelhamento.",
    ),
    "v3_authorize_prompt_title_launcher": MessageLookupByLibrary.simpleMessage(
      "Os participantes gostariam de compartilhar sua tela",
    ),
    ...
    "v3_broadcast_indicator": MessageLookupByLibrary.simpleMessage("LIGADO"),
    "v3_broadcast_multicast_checkbox": MessageLookupByLibrary.simpleMessage(
      "Transmitir para 10-100 Dispositivos",
    ),
    "v3_broadcast_multicast_desc": MessageLookupByLibrary.simpleMessage(
      "O número de dispositivos receptores não pode ser alterado quando a projeção começa.",
    ),
    "v3_broadcast_multicast_warn": MessageLookupByLibrary.simpleMessage(
      "Interrompa toda a projeção para editar.",
    ),
    ...
    "v3_cast_to_device_list_msg": MessageLookupByLibrary.simpleMessage(
      "Máximo de até 10 dispositivos.",
    ),
    "v3_cast_to_device_menu_or": MessageLookupByLibrary.simpleMessage("Ou"),
    "v3_cast_to_device_menu_quick_connect1":
        MessageLookupByLibrary.simpleMessage("Conexão Rápida"),
    "v3_cast_to_device_menu_quick_connect2":
        MessageLookupByLibrary.simpleMessage("escaneando o código QR"),
    "v3_cast_to_device_menu_title": MessageLookupByLibrary.simpleMessage(
      "Junte-se para Receber Esta Tela",
    ),
    ...
    "v3_casting_ended_toast": MessageLookupByLibrary.simpleMessage(
      "O compartilhamento de tela foi encerrado.",
    ),
    "v3_casting_time_countdown": m0,
    "v3_casting_time_do_not_extend": MessageLookupByLibrary.simpleMessage(
      "Não estender",
    ),
    "v3_casting_time_extend": MessageLookupByLibrary.simpleMessage("Estender"),
    "v3_casting_time_extend_success_toast":
        MessageLookupByLibrary.simpleMessage("Estendido por 3 horas."),
    "v3_download_app_desc": MessageLookupByLibrary.simpleMessage(
      "Escaneie o código QR com seu dispositivo iOS ou Android para baixar",
    ),
    ...
    "v3_download_app_for_desktop_desc": MessageLookupByLibrary.simpleMessage(
      "Digite o seguinte URL para baixar.",
    ),
    ...
    "v3_download_app_for_mobile_desc": MessageLookupByLibrary.simpleMessage(
      "Escaneie o código QR para acesso instantâneo.",
    ),
    "v3_download_app_mobile_title": MessageLookupByLibrary.simpleMessage(
      "Móvel",
    ),
    "v3_download_app_or": MessageLookupByLibrary.simpleMessage("OU"),
    "v3_download_app_title": MessageLookupByLibrary.simpleMessage(
      "Baixar Aplicativo de Envio",
    ),
    "v3_eula_agree": MessageLookupByLibrary.simpleMessage("Concordar"),
    "v3_eula_disagree": MessageLookupByLibrary.simpleMessage("Discordar"),
    "v3_eula_launch": MessageLookupByLibrary.simpleMessage("Iniciar"),
    ...
    "v3_exit_moderator_mode_desc": MessageLookupByLibrary.simpleMessage(
      "Tem certeza? Isso desconectará todos os participantes.",
    ),
    "v3_exit_moderator_mode_exit": MessageLookupByLibrary.simpleMessage("Sair"),
    "v3_exit_moderator_mode_title": MessageLookupByLibrary.simpleMessage(
      "Sair do Modo Moderador",
    ),
    "v3_group_dialog_accept": MessageLookupByLibrary.simpleMessage("Aceitar"),
    "v3_group_dialog_decline": MessageLookupByLibrary.simpleMessage("Recusar"),
    "v3_group_dialog_message": MessageLookupByLibrary.simpleMessage(
      "%s enviou uma solicitação de transmissão para o seu dispositivo. Esta ação sincronizará e exibirá o conteúdo atual, você deseja aceitar esta solicitação?",
    ),
    ...
    "v3_group_dialog_title": MessageLookupByLibrary.simpleMessage(
      "Solicitação de transmissão de %s",
    ),
    ...
    "v3_group_reject_invited": MessageLookupByLibrary.simpleMessage(
      "recusou sua solicitação de transmissão, por favor verifique a configuração de transmissão.",
    ),
    ...
    "v3_help_center_cast_device_title_sub":
        MessageLookupByLibrary.simpleMessage(
          "IFP transmitindo sua tela para dispositivos.",
        ),
    "v3_help_center_close": MessageLookupByLibrary.simpleMessage("Fechar"),
    ...
    "v3_help_center_share_title_sub": MessageLookupByLibrary.simpleMessage(
      "Dispositivos compartilhando sua tela com o IFP.",
    ),
    ...
    "v3_instruction_share_screen": MessageLookupByLibrary.simpleMessage(
      "Compartilhe suas telas",
    ),
    "v3_instruction_support": MessageLookupByLibrary.simpleMessage(
      "Suporta compartilhamento via AirPlay, Google Cast ou Miracast",
    ),
    "v3_last_casting_time_countdown": MessageLookupByLibrary.simpleMessage(
      "O compartilhamento de tela está prestes a terminar. Por favor, reinicie o compartilhamento de tela, se necessário.",
    ),
    ...
    "v3_lbl_cast_device_close": MessageLookupByLibrary.simpleMessage(
      "Fechar conexão do dispositivo de transmissão",
    ),
    ...
    "v3_lbl_settings_broadcast": MessageLookupByLibrary.simpleMessage(
      "Abrir menu de configuração de transmissão",
    ),
    ...
    "v3_lbl_settings_broadcast_to_display_group":
        MessageLookupByLibrary.simpleMessage(
          "Abrir menu de transmissão para grupo de exibição",
        ),
    ...
    "v3_lbl_settings_broadcast_to_display_group_checkbox":
        MessageLookupByLibrary.simpleMessage("Selecionar %s"),
    "v3_lbl_settings_broadcast_to_display_group_confirm":
        MessageLookupByLibrary.simpleMessage(
          "Confirmar nenhum dispositivo selecionado.",
        ),
    ...
    "v3_lbl_settings_connectivity": MessageLookupByLibrary.simpleMessage(
      "Abrir menu de configuração de conectividade",
    ),
    ...
    "v3_lbl_settings_device_authorize_mode":
        MessageLookupByLibrary.simpleMessage(
          "Ativar/desativar modo de autorização",
        ),
    "v3_lbl_settings_device_auto_fill_otp":
        MessageLookupByLibrary.simpleMessage(
          "Ativar/desativar preenchimento automático de OTP",
        ),
    "v3_lbl_settings_device_high_image_quality":
        MessageLookupByLibrary.simpleMessage("Alta qualidade de imagem"),
    "v3_lbl_settings_device_launch_on_startup":
        MessageLookupByLibrary.simpleMessage(
          "Ativar/desativar modo de inicialização automática",
        ),
    ...
    "v3_lbl_settings_device_name_close": MessageLookupByLibrary.simpleMessage(
      "Fechar configuração de nome do dispositivo",
    ),
    ...
    "v3_lbl_settings_device_setting": MessageLookupByLibrary.simpleMessage(
      "Abrir menu de configuração do dispositivo",
    ),
    "v3_lbl_settings_device_smart_scaling":
        MessageLookupByLibrary.simpleMessage(
          "Ativar/desativar alternância de escala inteligente",
        ),
    ...
    "v3_lbl_settings_invite_group": MessageLookupByLibrary.simpleMessage(
      "Abrir menu suspenso de transmissão de tela",
    ),
    ...
    "v3_lbl_settings_show_display_code": MessageLookupByLibrary.simpleMessage(
      "Ativar/desativar alternância de código de exibição",
    ),
    "v3_lbl_settings_whats_new": MessageLookupByLibrary.simpleMessage(
      "Abrir menu de novidades",
    ),
    ...
    "v3_lbl_streaming_view_function_expand":
        MessageLookupByLibrary.simpleMessage("Expandir função de transmissão"),
    "v3_lbl_streaming_view_function_minimize":
        MessageLookupByLibrary.simpleMessage("Recolher função de transmissão"),
    "v3_lbl_streaming_view_minimize": MessageLookupByLibrary.simpleMessage(
      "Recolher visualização de transmissão",
    ),
    ...
    "v3_main_local_connection_only_dialog_desc":
        MessageLookupByLibrary.simpleMessage(
          "Apenas conexão LAN，por favor verifique a configuração de rede do dispositivo。",
        ),
    "v3_main_status_no_network": MessageLookupByLibrary.simpleMessage(
      "Não foi possível detectar uma conexão com a internet. Conecte-se a uma rede Wi-Fi ou intranet e tente novamente.",
    ),
    "v3_miracast_not_support": MessageLookupByLibrary.simpleMessage(
      "Miracast indisponível no momento. O canal Wi-Fi atual não suporta espelhamento de tela.",
    ),
    "v3_miracast_uibc_not_supported_message":
        MessageLookupByLibrary.simpleMessage(
          "Esta fonte não suporta Miracast touchback",
        ),
    ...
    "v3_moderator_disable_mirror_desc": MessageLookupByLibrary.simpleMessage(
      "O espelhamento será desativado no modo moderador",
    ),
    ...
    "v3_moderator_disable_mirror_title": MessageLookupByLibrary.simpleMessage(
      "Desativar Espelhamento para o Modo Moderador",
    ),
    "v3_moderator_mode": MessageLookupByLibrary.simpleMessage("Modo Moderador"),
    ...
    "v3_overlay_retry_dialog_title": MessageLookupByLibrary.simpleMessage(
      "Transmissão interrompida. Por favor, recupere a permissão de transmissão.",
    ),
    ...
    "v3_participants_desc": MessageLookupByLibrary.simpleMessage(
      "Máximo de até 6 participantes.",
    ),
    "v3_participants_desc_maximum_9": MessageLookupByLibrary.simpleMessage(
      "Máximo de até 9 participantes.",
    ),
    "v3_participants_title": MessageLookupByLibrary.simpleMessage(
      "Participantes",
    ),
    "v3_permission_description": MessageLookupByLibrary.simpleMessage(
      "Por favor, vá para \"Configuração\" do dispositivo e depois para o menu \"Aplicativo\" para conceder a permissão.",
    ),
    "v3_permission_exit": MessageLookupByLibrary.simpleMessage("Sair"),
    ...
    "v3_quick_connect_menu_bottom_msg": MessageLookupByLibrary.simpleMessage(
      "A tela dividida é ativada se dois ou mais usuários compartilharem telas.",
    ),
    ...
    "v3_recording_stopped_dialog_msg": MessageLookupByLibrary.simpleMessage(
      "Acesso à tela encerrado, então a gravação foi interrompida.",
    ),
    "v3_recording_stopped_dialog_title": MessageLookupByLibrary.simpleMessage(
      "Gravação de tela foi interrompida",
    ),
    "v3_setting_passcode_cancel": MessageLookupByLibrary.simpleMessage(
      "Cancelar",
    ),
    "v3_setting_passcode_clear": MessageLookupByLibrary.simpleMessage("Limpar"),
    ...
    "v3_setting_passcode_title": MessageLookupByLibrary.simpleMessage(
      "Insira o código de acesso para desbloquear Configurações",
    ),
    ...
    "v3_settings_all_the_time_info": MessageLookupByLibrary.simpleMessage(
      "Transmita a tela do IFP de origem o tempo todo.",
    ),
    ...
    "v3_settings_broadcast_ip_error": MessageLookupByLibrary.simpleMessage(
      "Por favor, insira um endereço IP válido.",
    ),
    ...
    "v3_settings_broadcast_screen_energy_saving":
        MessageLookupByLibrary.simpleMessage(
          "Por favor, desative a economia de energia para evitar interrupções inesperadas durante a transmissão.",
        ),
    "v3_settings_broadcast_to_display_group":
        MessageLookupByLibrary.simpleMessage(
          "Transmitir para o grupo de exibição",
        ),
    ...
    "v3_settings_connectivity_internet_desc":
        MessageLookupByLibrary.simpleMessage(
          "A conexão de internet requer uma rede estável.",
        ),
    ...
    "v3_settings_connectivity_local_desc": MessageLookupByLibrary.simpleMessage(
      "Conexões locais operam dentro de uma rede privada, oferecendo mais segurança e estabilidade.",
    ),
    "v3_settings_device_authorize_mode": MessageLookupByLibrary.simpleMessage(
      "Exigir aprovação para todas as solicitações de compartilhamento de tela.",
    ),
    "v3_settings_device_auto_fill_otp": MessageLookupByLibrary.simpleMessage(
      "Preenchimento automático de senha única",
    ),
    "v3_settings_device_auto_fill_otp_desc": MessageLookupByLibrary.simpleMessage(
      "Habilite a conexão com um toque quando este dispositivo for selecionado no menu de Conexão Rápida do aplicativo de envio.",
    ),
    "v3_settings_device_high_image_quality":
        MessageLookupByLibrary.simpleMessage("Alta qualidade de imagem"),
    "v3_settings_device_high_image_quality_off_desc":
        MessageLookupByLibrary.simpleMessage(
          "Compartilhamento de tela QHD máximo (2K) dependendo da resolução da tela do remetente.",
        ),
    "v3_settings_device_high_image_quality_on_desc":
        MessageLookupByLibrary.simpleMessage(
          "Compartilhamento de tela UHD máximo (4K) do remetente web e 3K+ do remetente Windows e macOS dependendo da resolução da tela do remetente. Requer uma rede de alta qualidade.",
        ),
    "v3_settings_device_launch_on_startup":
        MessageLookupByLibrary.simpleMessage(
          "Iniciar AirSync na inicialização",
        ),
    ...
    "v3_settings_device_not_supported": MessageLookupByLibrary.simpleMessage(
      "Versão do dispositivo não é suportada",
    ),
    ...
    "v3_settings_device_show_display_code":
        MessageLookupByLibrary.simpleMessage(
          "Mostrar código de exibição no topo",
        ),
    "v3_settings_device_show_display_code_desc":
        MessageLookupByLibrary.simpleMessage(
          "Mantenha o código visível no topo da tela, mesmo ao alternar para outros aplicativos e o compartilhamento de tela estiver ativo.",
        ),
    ...
    "v3_settings_device_smart_scaling_desc": MessageLookupByLibrary.simpleMessage(
      "Ajuste automaticamente o tamanho da tela para maximizar o uso do espaço da tela. A imagem pode ficar ligeiramente distorcida.",
    ),
    ...
    "v3_settings_mirroring_auto_accept_desc": MessageLookupByLibrary.simpleMessage(
      "Habilite instantaneamente o espelhamento sem exigir aprovação do moderador.",
    ),
    "v3_settings_mirroring_blocked": MessageLookupByLibrary.simpleMessage(
      "Desative o modo moderador primeiro.",
    ),
    "v3_settings_mirroring_require_passcode":
        MessageLookupByLibrary.simpleMessage("Exigir código de acesso"),
    ...
    "v3_settings_only_when_casting_info": MessageLookupByLibrary.simpleMessage(
      "Transmita a tela do IFP de origem apenas quando estiver recebendo uma tela compartilhada.",
    ),
    ...
    "v3_settings_privacy_policy_description": MessageLookupByLibrary.simpleMessage(
      "A ViewSonic está comprometida em proteger sua privacidade e trata o manuseio de dados pessoais com seriedade. A Política de Privacidade abaixo detalha como a ViewSonic tratará seus dados pessoais após serem coletados pela ViewSonic através do uso do Website. A ViewSonic mantém a privacidade de suas informações usando tecnologias de segurança e adere a políticas que impedem o uso não autorizado de suas informações pessoais. Ao usar este Website, você consente com a coleta e uso de suas informações.\n\nOs websites que você acessa a partir do ViewSonic.com podem ter sua própria política de privacidade que pode diferir da política da ViewSonic. Por favor, revise as políticas de privacidade desses websites para obter informações detalhadas sobre como eles podem usar as informações coletadas enquanto você os visita.\n\nClique nos links a seguir para saber mais sobre nossa Política de Privacidade.",
    ),
    "v3_settings_resize_text_size": MessageLookupByLibrary.simpleMessage(
      "Redimensionar tamanho do texto",
    ),
    "v3_settings_resize_text_size_extra_large":
        MessageLookupByLibrary.simpleMessage("Muito grande"),
    ...
    "v3_settings_whats_new": MessageLookupByLibrary.simpleMessage("Novidades"),
    "v3_settings_whats_new_content": MessageLookupByLibrary.simpleMessage(
      "AirSync %s\n\nAirSync é uma solução proprietária de compartilhamento de tela sem fio da ViewSonic. Quando utilizado com o transmissor AirSync, permite que os usuários compartilhem suas telas perfeitamente com displays interativos ViewSonic.\n\nEsta versão inclui os seguintes novos recursos:\n\n1. Suporte para visualização de tela dividida do ViewBoard.\n\n2. Suporte para compartilhamento de tela de alta qualidade (até 4K) através do transmissor web.\n\n3. Silenciar saída de áudio do dispositivo ao compartilhar através do transmissor Windows.\n\n4. Estabilidade aprimorada.\n\n5. Correção de vários bugs.\n",
    ),
    ...
    "v3_shortcuts_cast_device": MessageLookupByLibrary.simpleMessage(
      "Transmitir para dispositivos",
    ),
    "v3_shortcuts_cast_device_desc": MessageLookupByLibrary.simpleMessage(
      "Transmita esta tela para vários dispositivos, incluindo laptops, tablets e dispositivos móveis simultaneamente.",
    ),
    "v3_shortcuts_google_cast": MessageLookupByLibrary.simpleMessage(
      "Google Cast",
    ),
    "v3_shortcuts_menu_title": MessageLookupByLibrary.simpleMessage("Atalhos"),
    ...
    "v3_touchback_alert_message": MessageLookupByLibrary.simpleMessage(
      "Você só pode usar touchback em um dispositivo por vez.",
    ),
    ...
    "v3_touchback_disable_message": MessageLookupByLibrary.simpleMessage(
      "TouchBack está desativado.",
    ),
    "v3_touchback_fail_message": MessageLookupByLibrary.simpleMessage(
      "Falha no emparelhamento. TouchBack não está ativado. Por favor, tente novamente.",
    ),
    "v3_touchback_ipad_bluetooth_hint": MessageLookupByLibrary.simpleMessage(
      "Abrir a página de configurações de Bluetooth no seu iPad pode acelerar o processo de emparelhamento.",
    ),
    ...
    "v3_touchback_restart_bluetooth_message": MessageLookupByLibrary.simpleMessage(
      "Tempo limite da operação. Por favor, desligue e reinicie a função Bluetooth na tela grande e reinicie o touchback.",
    ),
    "v3_touchback_restart_bluetooth_title":
        MessageLookupByLibrary.simpleMessage(
          "Tempo limite da operação, por favor reinicie o Bluetooth",
        ),
    "v3_touchback_state_deviceFinding_message":
        MessageLookupByLibrary.simpleMessage("Localizando dispositivo"),
    "v3_touchback_state_deviceFoundSuccess_message":
        MessageLookupByLibrary.simpleMessage(
          "Dispositivo localizado com sucesso",
        ),
    ...
    "v3_touchback_state_devicePairing_message":
        MessageLookupByLibrary.simpleMessage("Emparelhando dispositivo"),
    ...
    "v3_touchback_state_hidProfileServiceStartedSuccess_message":
        MessageLookupByLibrary.simpleMessage(
          "Serviço de perfil HID iniciado com sucesso",
        ),
    "v3_touchback_state_hidProfileServiceStarting_message":
        MessageLookupByLibrary.simpleMessage("Iniciando serviço de perfil HID"),
    ...
    "v3_touchback_success_message": MessageLookupByLibrary.simpleMessage(
      "Agora você pode controlar %s remotamente a partir do IFP.",
    ),
    "v3_waiting_desc": MessageLookupByLibrary.simpleMessage(
      "Aguardando este participante compartilhar sua tela",
    ),
