                  ...
                  child: Column(
                    ...
                    children: [
                      V3Focus(
                        ...
                        identifier:
                            'v3_qa_streaming_shortcut_cast_device_toggle',
                        child: Row(
                      ...
                      SizedBox(
                          height: context.tokens.spacing.vsdslSpacingSm.top),
                      AutoSizeText(
                                ...
                                if (mirrorStateProvider.isVB005AndDFSChannel)
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: context
                                          .tokens.color.vsdslColorSurface900,
                                      borderRadius: BorderRadius.circular(10),
                                    ),
                                    padding:
                                        context.tokens.spacing.vsdslSpacingLg,
                                    child: Row(
                                      children: [
                                        SvgPicture.asset(
                                        ...
                                        Gap(context.tokens.spacing
                                            .vsdslSpacingLg.right),
                                        SizedBox(
                                          width: 200,
                                          child: AutoSizeText(
                                            S
