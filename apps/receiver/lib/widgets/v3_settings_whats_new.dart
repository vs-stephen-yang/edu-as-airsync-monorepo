...
class V3SettingsWhatsNew extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final appVersionString = 'v${AppConfig.of(context)?.appVersion ?? ''}';
    final textSizeOption = AppPreferences().textSizeOption;
  ...
  Widget _whatsNewContent(
    BuildContext context,
    String appVersionString,
    ResizeTextSizeOption textSizeOption,
  ) {
    ...
    final text = sprintf(
        S.of(context).v3_settings_whats_new_content, [appVersionString]);

    return textSizeOption != ResizeTextSizeOption.normal
