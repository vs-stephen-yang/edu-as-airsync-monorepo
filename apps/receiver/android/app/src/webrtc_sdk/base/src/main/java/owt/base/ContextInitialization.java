...
public class ContextInitialization {
    ...
    /**
     * Set the customized loggable factory.
     *
     * @param loggable Loggable to be set.
     * @return ContextInitialization
     */
    public ContextInitialization setCustomizedLoggableFactory(
            Loggable loggable, Logging.Severity severity) {
        RCHECK(!initialized);
        PCFactoryProxy.loggable = loggable;
        PCFactoryProxy.severity = severity;
        return this;
    }
