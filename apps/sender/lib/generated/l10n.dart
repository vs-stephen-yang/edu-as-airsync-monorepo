...
class S {
  ...
  /// `Cancel`
  String get v3_exit_action_cancel {
    return Intl.message(
      'Cancel',
      name: 'v3_exit_action_cancel',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Exit`
  String get v3_exit_action_exit {
    return Intl.message(
      'Exit',
      name: 'v3_exit_action_exit',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Cancel`
  String get v3_lbl_exit_action_cancel {
    return Intl.message(
      'Cancel',
      name: 'v3_lbl_exit_action_cancel',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Exit`
  String get v3_lbl_exit_action_exit {
    return Intl.message(
      'Exit',
      name: 'v3_lbl_exit_action_exit',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Knowledge Base`
  String get v3_main_knowledge_base {
    return Intl.message(
      'Knowledge Base',
      name: 'v3_main_knowledge_base',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Knowledge Base`
  String get v3_lbl_main_knowledge_base {
    return Intl.message(
      'Knowledge Base',
      name: 'v3_lbl_main_knowledge_base',
      desc: '',
      args: [],
    );
  }
