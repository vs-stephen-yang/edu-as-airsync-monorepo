...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(year, version) =>
      "AirSync ©${year}. versio ${version} (Ind.)";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "v3_exit_action_cancel":
            MessageLookupByLibrary.simpleMessage("Peruuta"),
        "v3_exit_action_exit": MessageLookupByLibrary.simpleMessage("Poistu"),
        "v3_exit_title":
            MessageLookupByLibrary.simpleMessage("Haluatko varmasti lopettaa?"),
        ...
        "v3_lbl_device_list_close":
            MessageLookupByLibrary.simpleMessage("Sulje laitelista"),
        "v3_lbl_device_list_next":
            MessageLookupByLibrary.simpleMessage("Seuraava"),
        "v3_lbl_download_independent_version":
            MessageLookupByLibrary.simpleMessage(
                "Hanki Macin itsenäinen versio"),
        "v3_lbl_download_menu_minimal":
            MessageLookupByLibrary.simpleMessage("valikko minimissä"),
        "v3_lbl_exit_action_cancel":
            MessageLookupByLibrary.simpleMessage("Peruuta"),
        "v3_lbl_exit_action_exit":
            MessageLookupByLibrary.simpleMessage("Poistu"),
        "v3_lbl_main_display_code":
            MessageLookupByLibrary.simpleMessage("Kirjoita näyttökoodi"),
        "v3_lbl_main_display_code_remove":
            MessageLookupByLibrary.simpleMessage("Tyhjennä näyttökoodi"),
        "v3_lbl_main_download":
            MessageLookupByLibrary.simpleMessage("Lataa Sender-sovellus"),
        "v3_lbl_main_download_mac_store":
            MessageLookupByLibrary.simpleMessage("Hanki Mac App Store -versio"),
        "v3_lbl_main_download_mobile":
            MessageLookupByLibrary.simpleMessage("Hanki mobiiliversio"),
        "v3_lbl_main_download_windows":
            MessageLookupByLibrary.simpleMessage("Hanki Windows-versio"),
        "v3_lbl_main_moderator_action":
            MessageLookupByLibrary.simpleMessage("Lähetä Jaa"),
        "v3_lbl_main_moderator_input_hint":
            MessageLookupByLibrary.simpleMessage("Kirjoita nimesi"),
        "v3_lbl_main_password":
            MessageLookupByLibrary.simpleMessage("Kirjoita salasana"),
        "v3_lbl_main_present_action":
            MessageLookupByLibrary.simpleMessage("Lähetä Seuraava"),
        "v3_lbl_main_privacy":
            MessageLookupByLibrary.simpleMessage("Tietosuojakäytäntö"),
        "v3_lbl_main_receive_app_action":
            MessageLookupByLibrary.simpleMessage("Lähetä Yhdistä"),
        "v3_lbl_moderator_back":
            MessageLookupByLibrary.simpleMessage("Palaa takaisin"),
        ...
        "v3_lbl_present_idle_audio_driver_warning_close":
            MessageLookupByLibrary.simpleMessage("Sulje ääniajurin varoitus"),
        "v3_lbl_present_idle_audio_driver_warning_download":
            MessageLookupByLibrary.simpleMessage("Lataa ääniajuri"),
        "v3_lbl_qr_close":
            MessageLookupByLibrary.simpleMessage("Sulje QR-koodin lukija"),
        "v3_lbl_qr_code":
            MessageLookupByLibrary.simpleMessage("Avaa QR-koodin lukija"),
        ...
        "v3_lbl_select_screen_cancel":
            MessageLookupByLibrary.simpleMessage("Peruuta jakaminen"),
        "v3_lbl_select_screen_close":
            MessageLookupByLibrary.simpleMessage("Sulje näytön valinta"),
        ...
        "v3_lbl_select_screen_source_name":
            MessageLookupByLibrary.simpleMessage("Näytön lähde: %s"),
        "v3_lbl_setting": MessageLookupByLibrary.simpleMessage("Asetukset"),
        "v3_lbl_setting_language_select":
            MessageLookupByLibrary.simpleMessage("Valitse kieli: %s"),
        "v3_lbl_setting_legal_policy": MessageLookupByLibrary.simpleMessage(
            "Näytä oikeudellinen käytäntö: %s"),
        ...
        "v3_lbl_setting_software_update_fail_close":
            MessageLookupByLibrary.simpleMessage("Sulje päivitysvirheilmoitus"),
        "v3_lbl_setting_software_update_fail_ok":
            MessageLookupByLibrary.simpleMessage("OK"),
        "v3_lbl_setting_software_update_no_available":
            MessageLookupByLibrary.simpleMessage("Ei päivitystä saatavilla"),
        ...
        "v3_lbl_setting_update_close":
            MessageLookupByLibrary.simpleMessage("Sulje päivitysilmoitus"),
        "v3_lbl_sharing_pause_off":
            MessageLookupByLibrary.simpleMessage("Tauko pois päältä"),
        "v3_lbl_sharing_pause_on":
            MessageLookupByLibrary.simpleMessage("Tauko päällä"),
        "v3_lbl_sharing_stop":
            MessageLookupByLibrary.simpleMessage("Jakaminen lopetettu"),
        "v3_lbl_streaming_expand_button": MessageLookupByLibrary.simpleMessage(
            "Laajenna suoratoiston ohjaimet"),
        "v3_lbl_streaming_minimize_button":
            MessageLookupByLibrary.simpleMessage(
                "Pienennä suoratoiston ohjaimet"),
        "v3_lbl_streaming_stop_button":
            MessageLookupByLibrary.simpleMessage("Lopeta suoratoisto"),
        "v3_lbl_touch_back_off":
            MessageLookupByLibrary.simpleMessage("Poista Touchback käytöstä"),
        "v3_lbl_touch_back_on":
            MessageLookupByLibrary.simpleMessage("Ota Touchback käyttöön"),
        ...
        "v3_present_touch_back_dialog_allow":
            MessageLookupByLibrary.simpleMessage("Salli"),
        "v3_present_touch_back_dialog_description":
            MessageLookupByLibrary.simpleMessage(
                "Kun otat näytönjaon käyttöön, AirSync tallentaa ja lähettää näyttösi sisällön tilapäisesti valittuun näyttöön (esim. IFP). Touchback-toiminnon aktivoimiseksi AirSync tarvitsee Helppokäyttöisyys-palvelun käyttöoikeuden, jotta kauko-ohjaus näytöltä on mahdollista. AirSync ei kerää henkilötietojasi eikä seuraa toimintaasi. Tämä käyttöoikeus tarvitaan vain kosketusohjaustoiminnon mahdollistamiseksi."),
        "v3_present_touch_back_dialog_not_now":
            MessageLookupByLibrary.simpleMessage("Ei nyt"),
        "v3_present_touch_back_dialog_title":
            MessageLookupByLibrary.simpleMessage("Salli Touchback"),
        ...
        "v3_setting_accessibility_text_size":
            MessageLookupByLibrary.simpleMessage("Tekstin koko"),
