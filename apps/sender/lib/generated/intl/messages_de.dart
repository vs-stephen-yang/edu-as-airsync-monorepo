...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "v3_present_touch_back_dialog_description":
            MessageLookupByLibrary.simpleMessage(
                "Wenn Sie die Bildschirmfreigabe aktivieren, erfasst AirSync vorübergehend Ihren Bildschirminhalt und überträgt ihn an das ausgewählte Display (z. B. IFP).Um Touchback zu aktivieren, benötigt AirSync die Berechtigung für den Eingabehilfedienst, um die Fernsteuerung vom Display aus zu ermöglichen.AirSync sammelt keine personenbezogenen Daten und überwacht Ihre Aktionen nicht. Diese Berechtigung wird nur verwendet, um die Touch-Steuerungsfunktion zu aktivieren."),
