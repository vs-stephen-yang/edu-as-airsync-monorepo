...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(value) =>
      "Por favor, selecione uma tela para compartilhar dentro de ${value} segundos...";

  static String m1(year) =>
      "Copyright © ViewSonic Corporation ${year}. Todos os direitos reservados.";

  static String m2(year, version) => "AirSync ©${year}. versão ${version}";

  static String m3(year, version) =>
      "AirSync ©${year}. versão ${version} (Ind.)";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "main_connect_network_error": MessageLookupByLibrary.simpleMessage(
      "Erro de rede. Por favor, verifique a conectividade de rede e tente novamente.",
    ),
    "main_connect_rate_limited": MessageLookupByLibrary.simpleMessage(
      "A instância do AirSync está ocupada. Por favor, tente novamente mais tarde.",
    ),
    ...
    "main_connection_mode_unsupported": MessageLookupByLibrary.simpleMessage(
      "O AirSync não pode se conectar à Internet.",
    ),
    "main_device_list": MessageLookupByLibrary.simpleMessage("Conexão Rápida"),
    "main_display_code": MessageLookupByLibrary.simpleMessage(
      "Código de exibição",
    ),
    "main_display_code_description": MessageLookupByLibrary.simpleMessage(
      "Por favor, insira o código de exibição",
    ),
    ...
    "main_update_description_android": MessageLookupByLibrary.simpleMessage(
      "Por favor, clique em \"Atualizar\" para instalar a nova versão.",
    ),
    ...
    "main_update_error_title": MessageLookupByLibrary.simpleMessage(
      "Falha na atualização da versão",
    ),
    ...
    "present_select_screen_description": MessageLookupByLibrary.simpleMessage(
      "Escolha uma visualização para compartilhar com a tela receptora.",
    ),
    ...
    "present_select_screen_ios_restart_description":
        MessageLookupByLibrary.simpleMessage(
          "Clique em \"Iniciar transmissão\" para retomar o compartilhamento antes do tempo limite ou clique em \"Voltar\" para retornar à tela inicial.",
        ),
    ...
    "present_state_high_quality_description":
        MessageLookupByLibrary.simpleMessage(
          "Habilitar Alta Qualidade em boas condições de rede.",
        ),
    "present_state_high_quality_title": MessageLookupByLibrary.simpleMessage(
      "Alta Qualidade",
    ),
    "present_state_pause": MessageLookupByLibrary.simpleMessage("Pausar"),
    "present_state_resume": MessageLookupByLibrary.simpleMessage("Retomar"),
    "present_state_stop": MessageLookupByLibrary.simpleMessage(
      "Parar apresentação",
    ),
    "present_time": MessageLookupByLibrary.simpleMessage("Tempo decorrido"),
    ...
    "present_time_unit_sec": MessageLookupByLibrary.simpleMessage("seg"),
    "present_wait": m0,
    "remote_screen_connect_error": MessageLookupByLibrary.simpleMessage(
      "Erro de conexão com a tela remota",
    ),
    "remote_screen_wait": MessageLookupByLibrary.simpleMessage(
      "O compartilhamento está sendo processado. Por favor, aguarde.",
    ),
    ...
    "toast_enable_remote_screen": MessageLookupByLibrary.simpleMessage(
      "Por favor, habilite o compartilhamento de tela para o dispositivo no AirSync.",
    ),
    "toast_install_audio_driver": MessageLookupByLibrary.simpleMessage(
      "Por favor, instale o driver de áudio virtual.",
    ),
    "toast_maximum_moderated": MessageLookupByLibrary.simpleMessage(
      "O número máximo de sessões moderadas foi atingido.",
    ),
    "toast_maximum_remote_screen": MessageLookupByLibrary.simpleMessage(
      "O número máximo de telas compartilhadas foi atingido.",
    ),
    "toast_maximum_split_screen": MessageLookupByLibrary.simpleMessage(
      "O número máximo de telas divididas foi atingido.",
    ),
    ...
    "v3_device_list_dialog_invalid_otp": MessageLookupByLibrary.simpleMessage(
      "Senha única incorreta",
    ),
    "v3_device_list_dialog_title": MessageLookupByLibrary.simpleMessage(
      "Digite a senha única",
    ),
    "v3_device_list_next": MessageLookupByLibrary.simpleMessage("Próximo"),
    ...
    "v3_exit_action_exit": MessageLookupByLibrary.simpleMessage("Sair"),
    ...
    "v3_lbl_device_list_close": MessageLookupByLibrary.simpleMessage(
      "Fechar lista de dispositivos",
    ),
    "v3_lbl_device_list_next": MessageLookupByLibrary.simpleMessage("Próximo"),
    "v3_lbl_download_independent_version": MessageLookupByLibrary.simpleMessage(
      "Obtenha a versão independente do Mac",
    ),
    ...
    "v3_lbl_setting": MessageLookupByLibrary.simpleMessage("Configurações"),
    ...
    "v3_lbl_streaming_expand_button": MessageLookupByLibrary.simpleMessage(
      "Expandir controles de streaming",
    ),
    ...
    "v3_main_connect_rate_limited": MessageLookupByLibrary.simpleMessage(
      "Instância AirSync está ocupada. Por favor, tente novamente mais tarde.",
    ),
    ...
    "v3_main_connection_mode_unsupported": MessageLookupByLibrary.simpleMessage(
      "Seu receptor não suporta compartilhamento de tela pela Internet temporariamente.",
    ),
    ...
    "v3_main_download_desc": MessageLookupByLibrary.simpleMessage(
      "Compartilhamento de tela sem esforço com conexão de um clique.",
    ),
    ...
    "v3_main_download_title": MessageLookupByLibrary.simpleMessage(
      "Obtenha seu aplicativo AirSync sender",
    ),
    ...
    "v3_main_instance_not_found_or_offline":
        MessageLookupByLibrary.simpleMessage(
          "Código de exibição não encontrado ou instância está offline.",
        ),
    ...
    "v3_main_moderator_app_subtitle": MessageLookupByLibrary.simpleMessage(
      "Digite seu nome antes de compartilhar sua tela",
    ),
    ...
    "v3_main_moderator_input_limit": MessageLookupByLibrary.simpleMessage(
      "Por favor, limite o nome a 20 caracteres.",
    ),
    "v3_main_moderator_subtitle": MessageLookupByLibrary.simpleMessage(
      "Digite o título da sua apresentação",
    ),
    ...
    "v3_main_moderator_wait": MessageLookupByLibrary.simpleMessage(
      "Aguarde o moderador convidá-lo para compartilhar",
    ),
    "v3_main_otp_error": MessageLookupByLibrary.simpleMessage(
      "Aceita apenas números.",
    ),
    "v3_main_password": MessageLookupByLibrary.simpleMessage("Senha"),
    "v3_main_password_invalid": MessageLookupByLibrary.simpleMessage(
      "Senha inválida.",
    ),
    "v3_main_present_action": MessageLookupByLibrary.simpleMessage("Próximo"),
    "v3_main_present_or": MessageLookupByLibrary.simpleMessage("ou"),
    ...
    "v3_main_presenting_message": MessageLookupByLibrary.simpleMessage(
      "airsync.net está compartilhando sua tela.",
    ),
    ...
    "v3_main_receive_app_stop": MessageLookupByLibrary.simpleMessage("Parar"),
    "v3_main_receive_app_subtitle": MessageLookupByLibrary.simpleMessage(
      "Compartilhar tela com meu dispositivo",
    ),
    ...
    "v3_main_select_role_title": MessageLookupByLibrary.simpleMessage(
      "Escolha seu modo de apresentação",
    ),
    "v3_main_terms": MessageLookupByLibrary.simpleMessage("Termos de uso"),
    "v3_main_web_nonsupport": MessageLookupByLibrary.simpleMessage(
      "Atualmente, apenas os navegadores Chrome e Edge são suportados.",
    ),
    ...
    "v3_present_joined_before_moderator_on_description":
        MessageLookupByLibrary.simpleMessage(
          "Moderador está Ativado. Por favor, reconecte-se.",
        ),
    "v3_present_moderator_exited": MessageLookupByLibrary.simpleMessage(
      "O moderador encerrou",
    ),
    ...
    "v3_present_moderator_exited_description":
        MessageLookupByLibrary.simpleMessage(
          "O moderador encerrou. Por favor, reconecte-se.",
        ),
    "v3_present_options_menu_he_subtitle": MessageLookupByLibrary.simpleMessage(
      "Use a placa gráfica do dispositivo para codificar o stream.",
    ),
    ...
    "v3_present_options_menu_hq_subtitle": MessageLookupByLibrary.simpleMessage(
      "Use uma taxa de bits maior para transmitir o stream.",
    ),
    ...
    "v3_present_select_screen_extension_desc":
        MessageLookupByLibrary.simpleMessage("Expanda seu espaço de trabalho"),
    "v3_present_select_screen_extension_desc2":
        MessageLookupByLibrary.simpleMessage(
          "Arraste conteúdo entre seu dispositivo pessoal e o IFP, aprimorando a interação e controle em tempo real.",
        ),
    ...
    "v3_present_select_screen_subtitle": MessageLookupByLibrary.simpleMessage(
      "%s deseja compartilhar sua tela. Escolha o que compartilhar.",
    ),
    ...
    "v3_present_session_full_description": MessageLookupByLibrary.simpleMessage(
      "Não é possível participar. A sessão atingiu seu limite máximo.",
    ),
    "v3_present_touch_back_allow": MessageLookupByLibrary.simpleMessage(
      "Permitir toque de retorno",
    ),
    ...
    "v3_present_touch_back_dialog_description":
        MessageLookupByLibrary.simpleMessage(
          "Quando você ativa o compartilhamento de tela, o AirSync capturará e transmitirá temporariamente o conteúdo da sua tela para o display selecionado (por exemplo, IFP). Para ativar o Toque de Retorno, o AirSync requer permissão do Serviço de Acessibilidade para permitir controle remoto a partir do display. O AirSync não coleta seus dados pessoais nem monitora suas ações. Esta permissão é usada apenas para ativar o recurso de controle por toque.",
        ),
    ...
    "v3_receiver_remote_screen_busy_description":
        MessageLookupByLibrary.simpleMessage(
          "A tela está transmitindo para outras telas. Por favor, tente novamente mais tarde.",
        ),
    "v3_receiver_remote_screen_busy_title":
        MessageLookupByLibrary.simpleMessage("A tela está transmitindo"),
    "v3_scan_qr_reminder": MessageLookupByLibrary.simpleMessage(
      "Conexão rápida ao escanear o código QR",
    ),
    ...
    "v3_setting_software_update_no_available_description":
        MessageLookupByLibrary.simpleMessage(
          "O AirSync já está atualizado com a versão mais recente.",
        ),
    ...
    "v3_setting_software_update_positive_action":
        MessageLookupByLibrary.simpleMessage("Atualizar"),
    "v3_setting_title": MessageLookupByLibrary.simpleMessage("Configurações"),
  };
}
