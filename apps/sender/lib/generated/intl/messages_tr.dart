...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(value) =>
      "Lütfen ${value} saniye içinde paylaşılacak bir ekran seçin...";

  static String m1(year) =>
      "Telif hakkı © ViewSonic Corporation ${year}. Tüm hakları saklıdır.";

  static String m2(year, version) => "AirSync ©${year}. sürüm ${version}";

  static String m3(year, version) =>
      "AirSync ©${year}. sürüm ${version} (Bağım.)";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "device_list_enter_pin_ok": MessageLookupByLibrary.simpleMessage("TAMAM"),
    "main_connect_network_error": MessageLookupByLibrary.simpleMessage(
      "Ağ hatası. Lütfen ağ bağlantınızı kontrol edin ve tekrar deneyin.",
    ),
    "main_connect_rate_limited": MessageLookupByLibrary.simpleMessage(
      "AirSync örneği meşgul. Lütfen daha sonra tekrar deneyin.",
    ),
    ...
    "main_connection_mode_unsupported": MessageLookupByLibrary.simpleMessage(
      "AirSync internete bağlanamıyor.",
    ),
    "main_device_list": MessageLookupByLibrary.simpleMessage("Hızlı Bağlantı"),
    "main_display_code": MessageLookupByLibrary.simpleMessage("Ekran kodu"),
    "main_display_code_description": MessageLookupByLibrary.simpleMessage(
      "Lütfen ekran kodunu girin",
    ),
    "main_display_code_error": MessageLookupByLibrary.simpleMessage(
      "Sadece harf ve rakam kabul eder.",
    ),
    "main_display_code_exceed": MessageLookupByLibrary.simpleMessage(
      "Maksimum katılımcı sayısına (6) ulaşıldı.",
    ),
    "main_display_code_exceed_split_screen":
        MessageLookupByLibrary.simpleMessage(
          "Maksimum sunucu sayısına (4) ulaşıldı.",
        ),
    ...
    "main_instance_not_found_or_offline": MessageLookupByLibrary.simpleMessage(
      "Ekran kodu bulunamadı veya örnek çevrimdışı.",
    ),
    "main_language": MessageLookupByLibrary.simpleMessage("Dil"),
    "main_language_name": MessageLookupByLibrary.simpleMessage("Türkçe"),
    "main_notice_not_support_description": MessageLookupByLibrary.simpleMessage(
      "Tarayıcı üzerinden paylaşım mobil cihazlarda desteklenmez. Daha iyi bir deneyim için lütfen AirSync gönderici uygulamasını indirin ve kullanın.",
    ),
    "main_notice_positive_button": MessageLookupByLibrary.simpleMessage(
      "AirSync gönderici uygulamasını indir.",
    ),
    "main_notice_title": MessageLookupByLibrary.simpleMessage("Uyarı"),
    "main_otp_error": MessageLookupByLibrary.simpleMessage(
      "Sadece rakam kabul eder.",
    ),
    "main_password": MessageLookupByLibrary.simpleMessage("Şifre"),
    "main_password_description": MessageLookupByLibrary.simpleMessage(
      "Lütfen tek kullanımlık şifreyi girin",
    ),
    "main_password_invalid": MessageLookupByLibrary.simpleMessage(
      "Şifre geçersiz.",
    ),
    "main_present": MessageLookupByLibrary.simpleMessage("İleri"),
    "main_setting": MessageLookupByLibrary.simpleMessage("Ayarlar"),
    ...
    "main_update_description_android": MessageLookupByLibrary.simpleMessage(
      "Yeni sürümü yüklemek için lütfen \"Güncelle\"ye tıklayın.",
    ),
    ...
    "moderator": MessageLookupByLibrary.simpleMessage("Lütfen adınızı girin"),
    "moderator_back": MessageLookupByLibrary.simpleMessage("Geri"),
    "moderator_exit": MessageLookupByLibrary.simpleMessage("ÇIKIŞ"),
    "moderator_fill_out": MessageLookupByLibrary.simpleMessage("Alan gerekli"),
    "moderator_name": MessageLookupByLibrary.simpleMessage("Ad"),
    "moderator_wait": MessageLookupByLibrary.simpleMessage(
      "Lütfen moderatör sunucuları seçerken bekleyin...",
    ),
    "present_role_cast_screen": MessageLookupByLibrary.simpleMessage(
      "Ekran paylaş",
    ),
    "present_role_receive": MessageLookupByLibrary.simpleMessage("Ekran al"),
    ...
    "present_select_screen_description": MessageLookupByLibrary.simpleMessage(
      "Alıcı ekranla paylaşmak için bir görünüm seçin.",
    ),
    ...
    "present_select_screen_ios_restart_description":
        MessageLookupByLibrary.simpleMessage(
          "Zaman aşımından önce paylaşıma devam etmek için \"Yayına başla\"ya tıklayın veya başlangıç ekranına dönmek için \"Geri\"ye tıklayın.",
        ),
    ...
    "present_state_high_quality_description":
        MessageLookupByLibrary.simpleMessage(
          "İyi ağ koşullarında Yüksek Kalite\'yi etkinleştirin.",
        ),
    "present_state_high_quality_title": MessageLookupByLibrary.simpleMessage(
      "Yüksek Kalite",
    ),
    "present_state_pause": MessageLookupByLibrary.simpleMessage("Duraklat"),
    "present_state_resume": MessageLookupByLibrary.simpleMessage("Devam Et"),
    "present_state_stop": MessageLookupByLibrary.simpleMessage("Sunumu durdur"),
    "present_time": MessageLookupByLibrary.simpleMessage("Geçen süre"),
    "present_time_unit_hour": MessageLookupByLibrary.simpleMessage("sa"),
    "present_time_unit_min": MessageLookupByLibrary.simpleMessage("dk"),
    "present_time_unit_sec": MessageLookupByLibrary.simpleMessage("sn"),
    "present_wait": m0,
    "remote_screen_connect_error": MessageLookupByLibrary.simpleMessage(
      "Uzaktan ekran bağlantı hatası",
    ),
    "remote_screen_wait": MessageLookupByLibrary.simpleMessage(
      "Paylaşım işleniyor. Lütfen bekleyin.",
    ),
    ...
    "v3_exit_action_cancel": MessageLookupByLibrary.simpleMessage("İptal"),
    "v3_exit_action_exit": MessageLookupByLibrary.simpleMessage("Çıkış"),
    ...
    "v3_lbl_device_list_button_device_list":
        MessageLookupByLibrary.simpleMessage("Cihaz Listesi"),
    "v3_lbl_device_list_close": MessageLookupByLibrary.simpleMessage(
      "Cihaz listesini kapat",
    ),
    "v3_lbl_device_list_next": MessageLookupByLibrary.simpleMessage("İleri"),
    "v3_lbl_download_independent_version": MessageLookupByLibrary.simpleMessage(
      "Mac bağımsız sürümünü edinin",
    ),
    "v3_lbl_download_menu_minimal": MessageLookupByLibrary.simpleMessage(
      "menü minimal",
    ),
    "v3_lbl_exit_action_cancel": MessageLookupByLibrary.simpleMessage("İptal"),
    "v3_lbl_exit_action_exit": MessageLookupByLibrary.simpleMessage("Çıkış"),
    ...
    "v3_lbl_moderator_back": MessageLookupByLibrary.simpleMessage("Geri dön"),
    "v3_lbl_moderator_disconnect": MessageLookupByLibrary.simpleMessage(
      "Bağlantıyı kes",
    ),
    "v3_lbl_present_idle_audio_driver_warning_close":
        MessageLookupByLibrary.simpleMessage("Ses sürücüsü uyarısını kapat"),
    "v3_lbl_present_idle_audio_driver_warning_download":
        MessageLookupByLibrary.simpleMessage("Ses sürücüsünü indir"),
    "v3_lbl_qr_close": MessageLookupByLibrary.simpleMessage(
      "QR kodu tarayıcısını kapat",
    ),
    "v3_lbl_qr_code": MessageLookupByLibrary.simpleMessage(
      "QR kodu tarayıcısını aç",
    ),
    "v3_lbl_select_language": MessageLookupByLibrary.simpleMessage("%s Seç"),
    ...
    "v3_lbl_setting": MessageLookupByLibrary.simpleMessage("Ayarlar"),
    ...
    "v3_lbl_setting_select": MessageLookupByLibrary.simpleMessage("%s Seç"),
    "v3_lbl_setting_software_update_deny_action":
        MessageLookupByLibrary.simpleMessage("Sonra"),
    "v3_lbl_setting_software_update_fail_close":
        MessageLookupByLibrary.simpleMessage(
          "Güncelleme hata iletişim kutusunu kapat",
        ),
    ...
    "v3_lbl_touch_back_off": MessageLookupByLibrary.simpleMessage(
      "Dokunmatik geri dönüşü devre dışı bırak",
    ),
    ...
    "v3_main_authorize_wait": MessageLookupByLibrary.simpleMessage(
      "Lütfen sunucunun isteğinizi onaylamasını bekleyin.",
    ),
    ...
    "v3_main_connection_mode_unsupported": MessageLookupByLibrary.simpleMessage(
      "Alıcınız geçici olarak İnternet ekran paylaşımını desteklemiyor.",
    ),
    "v3_main_copy_rights": m1,
    "v3_main_display_code": MessageLookupByLibrary.simpleMessage("Ekran kodu"),
    ...
    "v3_main_download_action_get": MessageLookupByLibrary.simpleMessage("Edin"),
    ...
    "v3_main_download_desc": MessageLookupByLibrary.simpleMessage(
      "Tek tıkla bağlantı ile zahmetsiz ekran paylaşımı.",
    ),
    ...
    "v3_main_download_title": MessageLookupByLibrary.simpleMessage(
      "AirSync gönderici uygulamanızı edinin",
    ),
    ...
    "v3_main_feedback": MessageLookupByLibrary.simpleMessage("Geri bildirim"),
    ...
    "v3_main_moderator_action": MessageLookupByLibrary.simpleMessage("Paylaş"),
    "v3_main_moderator_app_subtitle": MessageLookupByLibrary.simpleMessage(
      "Ekranınızı paylaşmadan önce adınızı yazın",
    ),
    ...
    "v3_main_presenting_message": MessageLookupByLibrary.simpleMessage(
      "airsync.net ekranınızı paylaşıyor.",
    ),
    ...
    "v3_main_receive_app_stop": MessageLookupByLibrary.simpleMessage("Durdur"),
    "v3_main_receive_app_subtitle": MessageLookupByLibrary.simpleMessage(
      "Ekranı cihazıma paylaş",
    ),
    "v3_main_receive_app_title": MessageLookupByLibrary.simpleMessage("Al"),
    "v3_main_select_role_receive": MessageLookupByLibrary.simpleMessage("Al"),
    "v3_main_select_role_share": MessageLookupByLibrary.simpleMessage("Paylaş"),
    "v3_main_select_role_title": MessageLookupByLibrary.simpleMessage(
      "Sunum modunuzu seçin",
    ),
    "v3_main_terms": MessageLookupByLibrary.simpleMessage("Kullanım koşulları"),
    "v3_main_web_nonsupport": MessageLookupByLibrary.simpleMessage(
      "Şu anda sadece Chrome ve Edge tarayıcıları desteklenmektedir.",
    ),
    ...
    "v3_present_moderator_exited_description":
        MessageLookupByLibrary.simpleMessage(
          "Moderatör oturumu kapattı. Lütfen yeniden bağlanın.",
        ),
    "v3_present_options_menu_he_subtitle": MessageLookupByLibrary.simpleMessage(
      "Akışı kodlamak için cihazın grafik kartını kullanın.",
    ),
    ...
    "v3_present_options_menu_hq_subtitle": MessageLookupByLibrary.simpleMessage(
      "Akışı iletmek için daha yüksek bir bit hızı kullanın.",
    ),
    ...
    "v3_present_select_screen_extension_desc":
        MessageLookupByLibrary.simpleMessage("Çalışma Alanınızı Genişletin"),
    "v3_present_select_screen_extension_desc2":
        MessageLookupByLibrary.simpleMessage(
          "Kişisel cihazınız ile IFP arasında içerik sürükleyin, gerçek zamanlı etkileşimi ve kontrolü artırın.",
        ),
    ...
    "v3_present_select_screen_subtitle": MessageLookupByLibrary.simpleMessage(
      "%s ekranınızı paylaşmak istiyor. Ne paylaşacağınızı seçin.",
    ),
    ...
    "v3_present_session_full_description": MessageLookupByLibrary.simpleMessage(
      "Katılamıyor. Oturum maksimum sınırına ulaştı.",
    ),
    "v3_present_touch_back_allow": MessageLookupByLibrary.simpleMessage(
      "Dokunmatik geri dönüşe izin ver",
    ),
    ...
    "v3_present_touch_back_dialog_description":
        MessageLookupByLibrary.simpleMessage(
          "Ekran paylaşımını etkinleştirdiğinizde, AirSync ekran içeriğinizi geçici olarak yakalar ve seçilen ekrana (örneğin IFP) iletir. Dokunmatik Geri Dönüşü etkinleştirmek için, AirSync\'in ekrandan uzaktan kontrol sağlamak üzere Erişilebilirlik Hizmeti iznine ihtiyacı vardır. AirSync kişisel verilerinizi toplamaz veya eylemlerinizi izlemez. Bu izin sadece dokunmatik kontrol özelliğini etkinleştirmek için kullanılır.",
        ),
    "v3_present_touch_back_dialog_not_now":
        MessageLookupByLibrary.simpleMessage("Şimdi değil"),
    "v3_present_touch_back_dialog_title": MessageLookupByLibrary.simpleMessage(
      "Dokunmatik Geri Dönüşe İzin Ver",
    ),
    "v3_receiver_remote_screen_busy_action":
        MessageLookupByLibrary.simpleMessage("TAMAM"),
    "v3_receiver_remote_screen_busy_description":
        MessageLookupByLibrary.simpleMessage(
          "Ekran diğer ekranlara yayın yapıyor. Lütfen daha sonra tekrar deneyin.",
        ),
    "v3_receiver_remote_screen_busy_title":
        MessageLookupByLibrary.simpleMessage("Ekran yayın yapıyor"),
    "v3_scan_qr_reminder": MessageLookupByLibrary.simpleMessage(
      "QR kodunu tarayarak hızlı bağlan",
    ),
    ...
    "v3_setting_language": MessageLookupByLibrary.simpleMessage("Dil"),
    ...
    "v3_setting_software_update_force_description":
        MessageLookupByLibrary.simpleMessage("Yeni bir sürüm mevcut."),
    ...
    "v3_setting_software_update_no_available_description":
        MessageLookupByLibrary.simpleMessage(
          "AirSync zaten en son sürümle güncel.",
        ),
    ...
    "v3_setting_software_update_positive_action":
        MessageLookupByLibrary.simpleMessage("Güncelle"),
    "v3_setting_title": MessageLookupByLibrary.simpleMessage("Ayarlar"),
  };
}
