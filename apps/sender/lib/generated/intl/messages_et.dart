...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "v3_present_touch_back_dialog_description":
            MessageLookupByLibrary.simpleMessage(
                "Kui lubate ekraani jagamise, jäädvustab AirSync ajutiselt teie ekraani sisu ja edastab selle valitud ekraanile (nt IFP).\\nTagasilöögi lubamiseks vajab AirSync juurdepääsetavuse teenuse luba, et lubada ekraanilt kaugjuhtimist.\\nAirSync ei kogu teie isikuandmeid ega jälgi teie tegevust. Seda luba kasutatakse ainult puutejuhtimise funktsiooni lubamiseks."),
