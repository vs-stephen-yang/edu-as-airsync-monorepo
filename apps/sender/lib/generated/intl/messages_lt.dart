...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "v3_present_touch_back_dialog_description":
        MessageLookupByLibrary.simpleMessage(
          "Leisti \"Touchback\"\nKai įgalinsite ekrano bendrinimą, \"AirSync\" laikinai užfiksuos ir perduos ekrano turinį į pasirinktą ekraną (pvz., IFP).\\nKad įgalintų jutiklinį grąžinimą, \"AirSync\" reikalauja pritaikymo neįgaliesiems paslaugos leidimo, kad būtų galima leisti nuotolinį valdymą iš ekrano.\\\"nAirSync\" nerenka jūsų asmeninių duomenų ir nestebi jūsų veiksmų. Šis leidimas naudojamas tik jutiklinio valdymo funkcijai įjungti.",
        ),
