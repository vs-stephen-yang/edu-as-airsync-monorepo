...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "main_connection_mode_unsupported":
            MessageLookupByLibrary.simpleMessage("AirSync はインターネットに接続できません。"),
        ...
        "main_otp_error":
            MessageLookupByLibrary.simpleMessage("*ワンタイムパスワードは 4 桁の数字です。"),
        "main_password": MessageLookupByLibrary.simpleMessage("パスワード"),
        "main_password_description":
            MessageLookupByLibrary.simpleMessage("ワンタイムパスワードを入力してください。"),
        "main_password_invalid":
            MessageLookupByLibrary.simpleMessage("パスワードが無効です。"),
        ...
        "main_update_error_title":
            MessageLookupByLibrary.simpleMessage("更新エラー"),
        "main_update_error_type":
            MessageLookupByLibrary.simpleMessage("エラーの原因: "),
        "main_update_positive_button":
            MessageLookupByLibrary.simpleMessage("更新"),
        "main_update_title":
            MessageLookupByLibrary.simpleMessage("新バージョンがあります"),
        ...
        "present_role_cast_screen":
            MessageLookupByLibrary.simpleMessage("画面を共有"),
        ...
        "present_select_screen_description":
            MessageLookupByLibrary.simpleMessage("受信画面と共有するビューを選択してください。"),
        "present_select_screen_entire":
            MessageLookupByLibrary.simpleMessage("全画面"),
        ...
        "present_select_screen_share":
            MessageLookupByLibrary.simpleMessage("共有"),
        "present_select_screen_share_audio":
            MessageLookupByLibrary.simpleMessage("画面音声を共有する"),
        "present_select_screen_window":
            MessageLookupByLibrary.simpleMessage("ウインドウ"),
        ...
        "remote_screen_connect_error":
            MessageLookupByLibrary.simpleMessage("リモート画面接続エラー"),
        "remote_screen_wait":
            MessageLookupByLibrary.simpleMessage("画面共有処理中です。しばらくお待ちください。"),
        "settings_audio_configuration":
            MessageLookupByLibrary.simpleMessage("オーディオ設定"),
        "settings_knowledge_base":
            MessageLookupByLibrary.simpleMessage("知識ベース"),
        ...
        "toast_maximum_moderated":
            MessageLookupByLibrary.simpleMessage("モデレーターセッション数の上限に達しました。"),
        "toast_maximum_remote_screen":
            MessageLookupByLibrary.simpleMessage("共有画面数が上限に達しました。"),
        "toast_maximum_split_screen":
            MessageLookupByLibrary.simpleMessage("分割画面数が上限に達しました。"),
        ...
        "v3_device_list_dialog_connect":
            MessageLookupByLibrary.simpleMessage("接続"),
        "v3_device_list_dialog_invalid_otp":
            MessageLookupByLibrary.simpleMessage("ワンタイムパスワードが間違っています"),
        ...
        "v3_lbl_device_list_close":
            MessageLookupByLibrary.simpleMessage("デバイスリストを閉じる"),
        ...
        "v3_lbl_main_display_code_remove":
            MessageLookupByLibrary.simpleMessage("ディスプレイコードを消去"),
        "v3_lbl_main_download":
            MessageLookupByLibrary.simpleMessage("AirSync Sender アプリをダウンロード"),
        "v3_lbl_main_download_mac_store":
            MessageLookupByLibrary.simpleMessage("Mac App Store 版を入手"),
        "v3_lbl_main_download_mobile":
            MessageLookupByLibrary.simpleMessage("モバイル版を入手"),
        "v3_lbl_main_download_windows":
            MessageLookupByLibrary.simpleMessage("Windows 版を入手"),
        "v3_lbl_main_moderator_action":
            MessageLookupByLibrary.simpleMessage("共有"),
        "v3_lbl_main_moderator_input_hint":
            MessageLookupByLibrary.simpleMessage("お名前を入力してください。"),
        ...
        "v3_lbl_moderator_disconnect":
            MessageLookupByLibrary.simpleMessage("切断"),
        ...
        "v3_lbl_qr_close":
            MessageLookupByLibrary.simpleMessage("QR コードスキャナーを閉じる"),
        "v3_lbl_qr_code":
            MessageLookupByLibrary.simpleMessage("QR コードスキャナーを開く"),
        "v3_lbl_select_language":
            MessageLookupByLibrary.simpleMessage("%s を選択"),
        "v3_lbl_select_role_receive":
            MessageLookupByLibrary.simpleMessage("画面を受信"),
        "v3_lbl_select_role_share":
            MessageLookupByLibrary.simpleMessage("画面を共有"),
        "v3_lbl_select_screen_audio":
            MessageLookupByLibrary.simpleMessage("PC オーディオを共有"),
        "v3_lbl_select_screen_cancel":
            MessageLookupByLibrary.simpleMessage("共有をキャンセル"),
        "v3_lbl_select_screen_close":
            MessageLookupByLibrary.simpleMessage("画面選択を閉じる"),
        ...
        "v3_lbl_select_screen_source_name":
            MessageLookupByLibrary.simpleMessage("画面ソース: %s"),
        "v3_lbl_setting": MessageLookupByLibrary.simpleMessage("設定"),
        "v3_lbl_setting_language_select":
            MessageLookupByLibrary.simpleMessage("言語選択: %s"),
        "v3_lbl_setting_legal_policy":
            MessageLookupByLibrary.simpleMessage("法的ポリシーを見る: %s"),
        "v3_lbl_setting_menu_back":
            MessageLookupByLibrary.simpleMessage("前のメニューに戻る"),
        "v3_lbl_setting_menu_close":
            MessageLookupByLibrary.simpleMessage("設定メニューを閉じる"),
        ...
        "v3_main_download_action_get":
            MessageLookupByLibrary.simpleMessage("入手"),
        "v3_main_download_app_dialog_desc":
            MessageLookupByLibrary.simpleMessage(
                "iOS または Android 端末で QR コードをスキャンしてダウンロードする"),
        "v3_main_download_app_dialog_title":
            MessageLookupByLibrary.simpleMessage("AirSync Sender をダウンロード"),
        "v3_main_download_app_subtitle":
            MessageLookupByLibrary.simpleMessage("iOS ＆ Android"),
        "v3_main_download_app_title":
            MessageLookupByLibrary.simpleMessage("AirSync アプリ"),
        "v3_main_download_desc":
            MessageLookupByLibrary.simpleMessage("ワンクリック接続で画面共有を簡単に。"),
        ...
        "v3_main_download_mac_store_label":
            MessageLookupByLibrary.simpleMessage("公式からインストール"),
        ...
        "v3_main_download_title":
            MessageLookupByLibrary.simpleMessage("AirSync Sender アプリを入手する"),
        ...
        "v3_main_moderator_app_subtitle":
            MessageLookupByLibrary.simpleMessage("画面共有の前にお名前を入力してください"),
        "v3_main_moderator_app_title":
            MessageLookupByLibrary.simpleMessage("共有"),
        "v3_main_moderator_disconnect":
            MessageLookupByLibrary.simpleMessage("接続解除"),
        "v3_main_moderator_input_hint":
            MessageLookupByLibrary.simpleMessage("お名前を入力してください"),
        "v3_main_moderator_input_limit":
            MessageLookupByLibrary.simpleMessage("お名前は20文字以内でご記入ください。"),
        "v3_main_moderator_subtitle":
            MessageLookupByLibrary.simpleMessage("プレゼンテーションのタイトルを入力してください"),
        "v3_main_moderator_title":
            MessageLookupByLibrary.simpleMessage("あなたの画面を共有"),
        "v3_main_moderator_wait":
            MessageLookupByLibrary.simpleMessage("モデレーターが共有を招待するまでお待ちください"),
        "v3_main_otp_error":
            MessageLookupByLibrary.simpleMessage("ワンタイムパスワードが間違っています。"),
        ...
        "v3_main_present_or": MessageLookupByLibrary.simpleMessage("または"),
        "v3_main_present_subtitle":
            MessageLookupByLibrary.simpleMessage("ステップに従ってスタートしましょう。"),
        "v3_main_present_title":
            MessageLookupByLibrary.simpleMessage("あなたの画面を共有"),
        "v3_main_presenting_message":
            MessageLookupByLibrary.simpleMessage("あなたの画面が共有されています"),
        ...
        "v3_present_moderator_exited":
            MessageLookupByLibrary.simpleMessage("モデレーターは終了しました"),
        ...
        "v3_present_options_menu_he_title":
            MessageLookupByLibrary.simpleMessage("ハードウェアエンコード"),
        "v3_present_options_menu_hq_subtitle":
            MessageLookupByLibrary.simpleMessage("より高いビットレートでストリームを伝送します。"),
        "v3_present_options_menu_hq_title":
            MessageLookupByLibrary.simpleMessage("高画質"),
        "v3_present_screen_full":
            MessageLookupByLibrary.simpleMessage("画面分割数は上限に達しました"),
        "v3_present_screen_full_action":
            MessageLookupByLibrary.simpleMessage("OK"),
        "v3_present_screen_full_description":
            MessageLookupByLibrary.simpleMessage("画面分割数は上限に達しました"),
        "v3_present_select_screen_extension":
            MessageLookupByLibrary.simpleMessage("画面拡張"),
        ...
        "v3_present_session_full":
            MessageLookupByLibrary.simpleMessage("セッション満席"),
        "v3_present_session_full_action":
            MessageLookupByLibrary.simpleMessage("OK"),
        "v3_present_session_full_description":
            MessageLookupByLibrary.simpleMessage("セッションが上限に達しましたため、参加できません。"),
        "v3_present_touch_back_allow":
            MessageLookupByLibrary.simpleMessage("タッチバックを有効"),
        "v3_present_touch_back_dialog_allow":
            MessageLookupByLibrary.simpleMessage("許可"),
        "v3_present_touch_back_dialog_description":
            MessageLookupByLibrary.simpleMessage(
                "画面共有を有効にすると、AirSync は一時的に画面の内容をキャプチャし、選択したディスプレイ (例：IFP) に送信します。タッチバックを有効にするには、AirSync はディスプレイからのリモートコントロールを可能にするため、アクセシビリティサービス権限が必要です。AirSync は個人データを収集したり、ユーザーの操作を監視したりしません。この権限は、タッチコントロール機能の有効化のみに利用されます。"),
        "v3_present_touch_back_dialog_not_now":
            MessageLookupByLibrary.simpleMessage("今はしない"),
        "v3_present_touch_back_dialog_title":
            MessageLookupByLibrary.simpleMessage("タッチバックの許可"),
        ...
        "v3_scan_qr_reminder":
            MessageLookupByLibrary.simpleMessage("QR コードをスキャンしてクイック接続"),
        "v3_select_screen_ios_countdown":
            MessageLookupByLibrary.simpleMessage("残り時間"),
        ...
        "v3_setting_software_update":
            MessageLookupByLibrary.simpleMessage("ソフトウェアのアップデート"),
