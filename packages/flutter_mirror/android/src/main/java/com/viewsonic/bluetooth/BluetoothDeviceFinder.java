...
public class BluetoothDeviceFinder {
  ...
  public boolean startFindingDevice(String deviceName) {
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
      ...
      public void onReceive(Context context, Intent intent) {
        ...
        if (BluetoothAdapter.ACTION_DISCOVERY_STARTED.equals(action)) {
          // Discovery has started, we can show a progress dialog or something
    ...
    // see https://developer.android.com/reference/android/bluetooth/BluetoothAdapter#startDiscovery()
    // This usually involves an inquiry scan of about 12 seconds.
