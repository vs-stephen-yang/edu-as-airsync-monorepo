...
Java_com_viewsonic_flutter_1multicast_1plugin_NativeBridge_receiveStart(JNIEnv *env, jobject thiz, jobject surface, jstring ip, jint port, jbyteArray jKey, jbyteArray jSalt, jint ssrc, jlong roc)
{
    ...
    g_receiver->start(c_ip, port, key, salt, native_ssrc, rocValue,
